...
.method private static loadFromFile(Lcom/antfin/cube/platform/draw/CSFont;Ljava/lang/String;Lcom/antfin/cube/platform/api/CKFontManager$LoadFontListener;)V
    ...
    const-string v1, "loadFromFile fail,file not exist:"

    const-string v2, "loadFromFile success : "
    ...
    invoke-virtual {p0, v1}, Lcom/antfin/cube/platform/draw/CSFont;->setTypeface(Landroid/graphics/Typeface;)V

    const/4 v1, 0x2

    invoke-virtual {p0, v1}, Lcom/antfin/cube/platform/draw/CSFont;->setState(I)V
