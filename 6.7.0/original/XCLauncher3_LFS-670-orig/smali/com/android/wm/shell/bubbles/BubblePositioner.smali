...
.method private adjustForTaskbar()V
    ...
    invoke-static {v0}, Landroidx/core/view/g;->w(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object v0

    invoke-static {v0}, Landroidx/core/view/g;->k(Landroid/view/WindowMetrics;)Landroid/view/WindowInsets;

    move-result-object v0

    invoke-static {}, La/b;->z()I
    ...
    invoke-static {v1}, Landroid/car/hardware/a;->a(Landroid/graphics/Insets;)I

    move-result v1

    iget-object v2, p0, Lcom/android/wm/shell/bubbles/BubblePositioner;->mInsets:Landroid/graphics/Insets;

    invoke-static {v2}, Landroid/car/hardware/a;->w(Landroid/graphics/Insets;)I
    ...
    invoke-static {v0}, Landroid/car/hardware/a;->a(Landroid/graphics/Insets;)I
    ...
    invoke-static {v0}, Landroid/car/hardware/a;->w(Landroid/graphics/Insets;)I
    ...
    invoke-static {v0}, Landroid/car/hardware/a;->s(Landroid/graphics/Insets;)I

    move-result v0

    iget-object v3, p0, Lcom/android/wm/shell/bubbles/BubblePositioner;->mInsets:Landroid/graphics/Insets;

    invoke-static {v3}, Landroid/car/hardware/a;->A(Landroid/graphics/Insets;)I

    move-result v3

    invoke-static {v1, v0, v2, v3}, Lcom/android/wm/shell/bubbles/b;->g(IIII)Landroid/graphics/Insets;
...
.method private getExpandedBubbleYForIme(II)F
    ...
    invoke-static {v2}, Landroid/car/hardware/a;->A(Landroid/graphics/Insets;)I
...
.method public getExpandedViewContainerPadding(ZZ)[I
    ...
    invoke-static {v6}, Landroid/car/hardware/a;->w(Landroid/graphics/Insets;)I
...
.method public getMaxExpandedViewHeight(Z)I
    ...
    invoke-static {v1}, Landroid/car/hardware/a;->s(Landroid/graphics/Insets;)I
...
.method public setRestingPosition(Landroid/graphics/PointF;)V
    ...
    invoke-static {p1}, Lcom/android/wm/shell/bubbles/d;->b(Landroid/graphics/PointF;)Landroid/graphics/PointF;
...
.method public update()V
    ...
    invoke-static {v0}, Landroidx/core/view/g;->f(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
