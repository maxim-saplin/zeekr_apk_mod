...
.method public synthetic constructor <init>(Landroid/animation/ValueAnimator;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/animation/Animation;Landroid/view/animation/Transformation;[FLandroid/graphics/Point;Lcom/android/wm/shell/common/TransactionPool;Lcom/android/wm/shell/common/ShellExecutor;Ljava/util/ArrayList;Ljava/lang/Runnable;)V
    ...
    iput-object p8, p0, Lcom/android/wm/shell/transition/b;->h:Lcom/android/wm/shell/common/TransactionPool;

    iput-object p9, p0, Lcom/android/wm/shell/transition/b;->i:Lcom/android/wm/shell/common/ShellExecutor;

    iput-object p10, p0, Lcom/android/wm/shell/transition/b;->j:Ljava/util/ArrayList;

    iput-object p11, p0, Lcom/android/wm/shell/transition/b;->k:Ljava/lang/Runnable;
...
.method public final run()V
    ...
    iget-object v7, p0, Lcom/android/wm/shell/transition/b;->h:Lcom/android/wm/shell/common/TransactionPool;

    iget-object v8, p0, Lcom/android/wm/shell/transition/b;->i:Lcom/android/wm/shell/common/ShellExecutor;

    iget-object v6, p0, Lcom/android/wm/shell/transition/b;->g:Landroid/graphics/Point;

    iget-object v9, p0, Lcom/android/wm/shell/transition/b;->j:Ljava/util/ArrayList;

    iget-object v10, p0, Lcom/android/wm/shell/transition/b;->k:Ljava/lang/Runnable;

    invoke-static/range {v0 .. v10}, Lcom/android/wm/shell/transition/DefaultTransitionHandler;->e(Landroid/animation/ValueAnimator;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/animation/Animation;Landroid/view/animation/Transformation;[FLandroid/graphics/Point;Lcom/android/wm/shell/common/TransactionPool;Lcom/android/wm/shell/common/ShellExecutor;Ljava/util/ArrayList;Ljava/lang/Runnable;)V
