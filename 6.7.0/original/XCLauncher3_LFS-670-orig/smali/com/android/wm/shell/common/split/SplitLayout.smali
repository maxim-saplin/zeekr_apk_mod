...
.method public constructor <init>(Ljava/lang/String;Landroid/content/Context;Landroid/content/res/Configuration;Lcom/android/wm/shell/common/split/SplitLayout$SplitLayoutHandler;Lcom/android/wm/shell/common/split/SplitWindowManager$ParentContainerCallbacks;Lcom/android/wm/shell/common/DisplayImeController;Lcom/android/wm/shell/ShellTaskOrganizer;Z)V
    ...
    invoke-static {p2}, Landroidx/core/view/g;->h(Landroid/content/Context;)Landroid/view/Display;
...
.method private static getDisplayInsets(Landroid/content/Context;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Landroidx/core/view/g;->m(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/view/g;->k(Landroid/view/WindowMetrics;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, v0}, La/b;->e(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private getDividerInsets(Landroid/content/res/Resources;Landroid/view/Display;)I
    ...
    invoke-static {p2}, Landroidx/core/app/a;->m(Landroid/view/Display;)Landroid/view/RoundedCorner;
    ...
    invoke-static {v0}, Landroidx/core/app/a;->c(Landroid/view/RoundedCorner;)I
    ...
    :cond_0
    invoke-static {p2}, Landroidx/core/app/a;->B(Landroid/view/Display;)Landroid/view/RoundedCorner;
    ...
    :cond_1
    invoke-static {p2}, Landroidx/core/app/a;->C(Landroid/view/Display;)Landroid/view/RoundedCorner;
    ...
    :cond_2
    invoke-static {p2}, Landroidx/core/app/a;->D(Landroid/view/Display;)Landroid/view/RoundedCorner;

    move-result-object p2

    if-eqz p2, :cond_3

    invoke-static {p2}, Landroidx/core/app/a;->c(Landroid/view/RoundedCorner;)I
...
.method public applySurfaceChanges(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)V
    ...
    invoke-static {p1, v2, v1, v0}, La/a;->q(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)V

    invoke-static {p1, v2}, Lcom/android/wm/shell/h;->x(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    invoke-static {p1, p2, v1, v0}, La/a;->g(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-static {p1, p3, v1, v0}, La/a;->g(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Landroid/car/a;->t(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
