...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/common/DisplayLayout;Lcom/android/wm/shell/onehanded/OneHandedSettingsUtil;Ljava/util/concurrent/Executor;)V
    ...
    new-instance p1, Lcom/android/wm/shell/onehanded/b;

    const/4 p2, 0x1

    invoke-direct {p1, p2}, Lcom/android/wm/shell/onehanded/b;-><init>(I)V
...
.method private updateThemeColors()V
    ...
    invoke-direct {p0, v1}, Lcom/android/wm/shell/onehanded/OneHandedBackgroundPanelOrganizer;->adjustColor(I)F
    ...
    iput-object v3, p0, Lcom/android/wm/shell/onehanded/OneHandedBackgroundPanelOrganizer;->mThemeColor:[F
...
.method public createBackgroundSurface()V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/wm/shell/onehanded/b;->c(Landroid/view/SurfaceControl$Builder;II)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-static {v0}, Lcom/android/wm/shell/onehanded/b;->b(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl$Builder;

    move-result-object v0

    invoke-static {v0}, Lcom/android/wm/shell/onehanded/b;->e(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl$Builder;

    move-result-object v0

    invoke-static {v0}, Lcom/android/wm/shell/onehanded/b;->g(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-static {v0}, Lcom/android/wm/shell/h;->l(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl;
...
.method public detachBackgroundFromParent(Landroid/animation/ValueAnimator;)V
    ...
    invoke-static {v1, p1}, Lcom/android/wm/shell/h;->j(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
...
.method public onAnimationUpdate(Landroid/view/SurfaceControl$Transaction;FF)V
    ...
    invoke-static {p1, p2, p3}, La/a;->p(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;F)V
...
.method public showBackgroundPanelLayer()V
    ...
    invoke-static {v0, v1}, Lcom/android/wm/shell/onehanded/b;->d(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;

    move-result-object v0

    iget-object v1, p0, Lcom/android/wm/shell/onehanded/OneHandedBackgroundPanelOrganizer;->mBackgroundSurface:Landroid/view/SurfaceControl;

    invoke-static {v0, v1}, Lcom/android/wm/shell/onehanded/b;->f(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
