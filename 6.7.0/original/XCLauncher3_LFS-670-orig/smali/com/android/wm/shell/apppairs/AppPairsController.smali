...
.method public unpair(IZ)V
    ...
    .line 5
    invoke-virtual {v2, p1}, Lcom/android/wm/shell/apppairs/AppPair;->contains(I)Z
    ...
    const-string/jumbo v0, "taskId %d isn\'t isn\'t in an app-pair."

    invoke-static {p2, v0, p1}, Lcom/android/internal/protolog/common/ProtoLog;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v2, "unpair taskId=%d pair=%s"
