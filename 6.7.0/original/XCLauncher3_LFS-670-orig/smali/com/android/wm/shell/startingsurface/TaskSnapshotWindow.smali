...
.method public constructor <init>(Landroid/view/SurfaceControl;Landroid/window/TaskSnapshot;Ljava/lang/CharSequence;Landroid/app/ActivityManager$TaskDescription;IIILandroid/graphics/Rect;IILandroid/view/InsetsState;Ljava/lang/Runnable;Lcom/android/wm/shell/common/ShellExecutor;)V
    ...
    invoke-static {p4}, La/a;->b(Landroid/app/ActivityManager$TaskDescription;)I
    ...
    invoke-static {p4}, Lcom/android/wm/shell/startingsurface/z;->a(Landroid/app/ActivityManager$TaskDescription;)I
...
.method public static create(Landroid/window/StartingWindowInfo;Landroid/os/IBinder;Landroid/window/TaskSnapshot;Lcom/android/wm/shell/common/ShellExecutor;Ljava/lang/Runnable;)Lcom/android/wm/shell/startingsurface/TaskSnapshotWindow;
    ...
    invoke-static {v4}, Lcom/android/wm/shell/startingsurface/l;->a(Landroid/view/WindowManager$LayoutParams;)I

    move-result v6

    invoke-static {v14, v6}, Lcom/android/wm/shell/startingsurface/l;->c(Landroid/view/WindowManager$LayoutParams;I)V

    invoke-static {v4}, Lcom/android/wm/shell/startingsurface/l;->f(Landroid/view/WindowManager$LayoutParams;)I

    move-result v6

    invoke-static {v14, v6}, Lcom/android/wm/shell/startingsurface/l;->g(Landroid/view/WindowManager$LayoutParams;I)V

    invoke-static {v4}, Lcom/android/wm/shell/startingsurface/l;->e(Landroid/view/WindowManager$LayoutParams;)Z

    move-result v4

    invoke-static {v14, v4}, Lcom/android/wm/shell/startingsurface/l;->d(Landroid/view/WindowManager$LayoutParams;Z)V
    ...
    new-array v7, v7, [Landroid/view/InsetsSourceControl;

    new-instance v31, Landroid/util/MergedConfiguration;

    invoke-direct/range {v31 .. v31}, Landroid/util/MergedConfiguration;-><init>()V

    invoke-static {v2}, Lcom/android/wm/shell/h;->a(Landroid/app/ActivityManager$RunningTaskInfo;)Landroid/app/ActivityManager$TaskDescription;
...
.method private drawSizeMismatchSnapshot()V
    ...
    invoke-static {v4, v1}, Lcom/android/wm/shell/h;->h(Landroid/view/SurfaceControl$Builder;Ljava/lang/String;)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-static {v4, v1}, Lcom/android/wm/shell/startingsurface/c;->b(ILandroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl$Builder;

    move-result-object v1

    iget-object v4, p0, Lcom/android/wm/shell/startingsurface/TaskSnapshotWindow;->mSurfaceControl:Landroid/view/SurfaceControl;

    invoke-static {v1, v4}, Lcom/android/wm/shell/h;->g(Landroid/view/SurfaceControl$Builder;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-static {v1}, Lcom/android/wm/shell/h;->l(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl;
    ...
    invoke-static {v5, v1, v6, v7}, La/a;->q(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)V
    ...
    invoke-static {v1}, Lcom/android/wm/shell/startingsurface/c;->d(Landroid/view/SurfaceControl;)V
...
.method public static getSystemBarInsets(Landroid/graphics/Rect;Landroid/view/InsetsState;)Landroid/graphics/Rect;
    ...
    invoke-static {}, Landroidx/core/view/g;->t()I
...
.method public calculateSnapshotCrop()Landroid/graphics/Rect;
    ...
    invoke-static {v0, v6, v4, v3, v1}, Landroidx/core/app/a;->q(Landroid/graphics/Rect;IIII)V
...
.method public drawBackgroundAndBars(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget v1, p0, Lcom/android/wm/shell/startingsurface/TaskSnapshotWindow;->mStatusBarColor:I
    ...
    :goto_4
    iget-object v9, p0, Lcom/android/wm/shell/startingsurface/TaskSnapshotWindow;->mBackgroundPaint:Landroid/graphics/Paint;
    ...
    iget-object v6, p0, Lcom/android/wm/shell/startingsurface/TaskSnapshotWindow;->mBackgroundPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/wm/shell/startingsurface/TaskSnapshotWindow$SystemBarBackgroundPainter;->drawDecors(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
...
.method public scheduleRemove(Ljava/lang/Runnable;Z)V
    ...
    invoke-direct {v0, v1, p0, p1}, Lcom/android/wm/shell/startingsurface/o;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
