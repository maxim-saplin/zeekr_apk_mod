...
.method public constructor <init>(Lcom/android/wm/shell/pip/phone/PipController;)V
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/wm/shell/pip/phone/o;-><init>(Ljava/lang/Object;I)V

    new-instance v2, Lcom/android/wm/shell/pip/phone/p;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lcom/android/wm/shell/pip/phone/p;-><init>(I)V
...
.method public static synthetic a(Lcom/android/wm/shell/pip/phone/PipController$IPipImpl;Lcom/android/wm/shell/pip/phone/PipController;)V
    .locals 0
...
.method public static synthetic b(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/view/SurfaceControl;Lcom/android/wm/shell/pip/phone/PipController;)V
    .locals 0
...
.method public static synthetic c(Lcom/android/wm/shell/pip/phone/PipController$IPipImpl;Lcom/android/wm/shell/pip/IPipAnimationListener;Lcom/android/wm/shell/pip/phone/PipController;)V
    .locals 0
...
.method public static synthetic e([Landroid/graphics/Rect;Landroid/content/ComponentName;Landroid/content/pm/ActivityInfo;Landroid/app/PictureInPictureParams;IILcom/android/wm/shell/pip/phone/PipController;)V
    .locals 0
...
.method public static synthetic f(ZILcom/android/wm/shell/pip/phone/PipController;)V
    .locals 0
...
.method public setShelfHeight(ZI)V
    ...
    invoke-direct {v1, p2, p1}, Lcom/android/wm/shell/pip/phone/r;-><init>(IZ)V
...
.method public startSwipePipToHome(Landroid/content/ComponentName;Landroid/content/pm/ActivityInfo;Landroid/app/PictureInPictureParams;II)Landroid/graphics/Rect;
    ...
    new-instance v11, Lcom/android/wm/shell/pip/phone/s;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/wm/shell/pip/phone/s;-><init>([Landroid/graphics/Rect;Landroid/content/ComponentName;Landroid/content/pm/ActivityInfo;Landroid/app/PictureInPictureParams;II)V
...
.method public stopSwipePipToHome(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/view/SurfaceControl;)V
    ...
    new-instance v1, Lcom/android/wm/shell/pip/phone/n;

    invoke-direct {v1, p1, p2, p3}, Lcom/android/wm/shell/pip/phone/n;-><init>(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/view/SurfaceControl;)V
