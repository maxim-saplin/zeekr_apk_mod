...
.method public a(Lcom/alibaba/fastjson2/JSONReader;Ljava/lang/reflect/Type;Ljava/lang/Object;J)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v4}, Lcom/alibaba/fastjson2/JSONReader;->t0(C)Z
    ...
    invoke-virtual {v1, v7, v8}, Lcom/alibaba/fastjson2/JSONReader;->t(J)J
    ...
    invoke-virtual {v1, v0}, Lcom/alibaba/fastjson2/JSONReader;->t0(C)Z
    ...
    invoke-virtual {v1, v5}, Lcom/alibaba/fastjson2/JSONReader;->W(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-wide v11, v14, Lcom/alibaba/fastjson2/JSONReader$Context;->k:J
    ...
    invoke-virtual {v6, v12}, Lcom/alibaba/fastjson2/reader/ObjectReaderBean;->x(Ljava/lang/Object;)V
    ...
    iget-object v11, v6, Lcom/alibaba/fastjson2/reader/ObjectReaderBean;->l:Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;

    if-nez v11, :cond_c

    iget-object v11, v14, Lcom/alibaba/fastjson2/JSONReader$Context;->n:Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;
    ...
    iget-wide v9, v14, Lcom/alibaba/fastjson2/JSONReader$Context;->k:J
    ...
    iget-object v15, v6, Lcom/alibaba/fastjson2/reader/ObjectReaderBean;->b:Ljava/lang/Class;

    if-eqz v11, :cond_f

    invoke-interface {v11}, Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;->apply()Ljava/lang/Class;
    ...
    invoke-interface {v11, v7, v15, v9, v10}, Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;->d(Ljava/lang/String;Ljava/lang/Class;J)Ljava/lang/Class;
    ...
    invoke-virtual {v8, v7}, Lcom/alibaba/fastjson2/JSONReader$Context;->d(Ljava/lang/reflect/Type;)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    invoke-interface {v6, v8, v13, v14}, Lcom/alibaba/fastjson2/reader/ObjectReader;->s(Lcom/alibaba/fastjson2/JSONReader$Context;J)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    invoke-virtual {v8, v7, v15, v9, v10}, Lcom/alibaba/fastjson2/JSONReader$Context;->f(Ljava/lang/String;Ljava/lang/Class;J)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    :cond_14
    invoke-interface {v7, v4, v5}, Lcom/alibaba/fastjson2/reader/ObjectReader;->h(J)Lcom/alibaba/fastjson2/reader/FieldReader;
    ...
    invoke-virtual {v9, v0, v8}, Lcom/alibaba/fastjson2/reader/FieldReader;->c(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :goto_7
    invoke-interface {v6, v4, v5}, Lcom/alibaba/fastjson2/reader/ObjectReader;->h(J)Lcom/alibaba/fastjson2/reader/FieldReader;
    ...
    iget-wide v7, v8, Lcom/alibaba/fastjson2/JSONReader$Context;->k:J
    ...
    :cond_1a
    invoke-virtual {v4, v1, v12}, Lcom/alibaba/fastjson2/reader/FieldReader;->u(Lcom/alibaba/fastjson2/JSONReader;Ljava/lang/Object;)V
...
.method public final j(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_0
    invoke-virtual {v0, p1, p2, p3}, Lcom/alibaba/fastjson2/reader/FieldReader;->e(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final w(Lcom/alibaba/fastjson2/JSONReader;Ljava/lang/Class;J)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    invoke-virtual {v1, v5}, Lcom/alibaba/fastjson2/JSONReader;->s0(B)Z
    ...
    iget-object v5, v1, Lcom/alibaba/fastjson2/JSONReader;->a:Lcom/alibaba/fastjson2/JSONReader$Context;

    iget-object v9, v5, Lcom/alibaba/fastjson2/JSONReader$Context;->n:Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;

    const-string v10, " -> "

    const-string/jumbo v11, "type not match. "
    ...
    invoke-interface {v9}, Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;->apply()Ljava/lang/Class;
    ...
    invoke-interface {v9, v6, v2, v3, v4}, Lcom/alibaba/fastjson2/JSONReader$AutoTypeBeforeHandler;->d(Ljava/lang/String;Ljava/lang/Class;J)Ljava/lang/Class;
    ...
    invoke-virtual {v1, v3, v4}, Lcom/alibaba/fastjson2/JSONReader;->t(J)J
    ...
    invoke-static {v11, v6, v10}, Landroid/car/a;->u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v5, v9}, Lcom/alibaba/fastjson2/JSONReader$Context;->d(Ljava/lang/reflect/Type;)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    :cond_3
    iget-object v6, v5, Lcom/alibaba/fastjson2/JSONReader$Context;->p:Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;

    invoke-virtual {v6, v7, v8}, Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;->g(J)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    invoke-virtual {v5, v6, v2, v3, v4}, Lcom/alibaba/fastjson2/JSONReader$Context;->f(Ljava/lang/String;Ljava/lang/Class;J)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    invoke-interface {v6}, Lcom/alibaba/fastjson2/reader/ObjectReader;->c()Ljava/lang/Class;
    ...
    iget-wide v6, v0, Lcom/alibaba/fastjson2/reader/ObjectReaderBean;->e:J
    ...
    invoke-virtual {v5, v2}, Lcom/alibaba/fastjson2/JSONReader$Context;->d(Ljava/lang/reflect/Type;)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    :cond_7
    iget-wide v1, v5, Lcom/alibaba/fastjson2/JSONReader$Context;->k:J
...
.method public final y(Lcom/alibaba/fastjson2/JSONReader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/alibaba/fastjson2/JSONReader;->t(J)J
    ...
    invoke-virtual {p1, v0}, Lcom/alibaba/fastjson2/JSONReader;->J0(Ljava/lang/reflect/Type;)Ljava/lang/Object;
...
.method public final z(Lcom/alibaba/fastjson2/JSONReader;Ljava/lang/reflect/Type;Ljava/lang/Object;J)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p4, p5}, Lcom/alibaba/fastjson2/JSONReader;->t(J)J
    ...
    :cond_1
    invoke-virtual {p1, p2}, Lcom/alibaba/fastjson2/JSONReader;->O0(Ljava/lang/reflect/Type;)Ljava/util/List;
