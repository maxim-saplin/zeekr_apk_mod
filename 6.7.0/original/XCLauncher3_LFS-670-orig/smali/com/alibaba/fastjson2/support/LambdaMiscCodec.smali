...
.method public static a(Ljava/lang/reflect/Constructor;)Ljava/util/function/BiFunction;
    ...
    invoke-static {v4, v3, v5}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v4

    invoke-virtual {v1, v0, v4}, Ljava/lang/invoke/MethodHandles$Lookup;->findConstructor(Ljava/lang/Class;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/MethodHandle;

    move-result-object v5

    const-string v4, "apply"

    sget-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->o:Ljava/lang/invoke/MethodType;

    sget-object v7, Lcom/alibaba/fastjson2/util/TypeUtils;->y:Ljava/lang/invoke/MethodType;

    filled-new-array {v2}, [Ljava/lang/Class;

    move-result-object v2

    invoke-static {v0, v3, v2}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
...
.method public static b(Ljava/lang/reflect/Method;)Ljava/util/function/BiFunction;
    ...
    invoke-static {v1, v4, v6}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v6

    invoke-virtual {v2, v0, v5, v6}, Ljava/lang/invoke/MethodHandles$Lookup;->findStatic(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v1, v4, v3}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    ...
    invoke-static {v1, v4}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v5

    invoke-virtual {v2, v0, v3, v5}, Ljava/lang/invoke/MethodHandles$Lookup;->findVirtual(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v1, v0, v4}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
...
.method public static f(Ljava/lang/reflect/Method;)Ljava/util/function/ObjIntConsumer;
    ...
    invoke-virtual {v1, v0, v5, v4}, Ljava/lang/invoke/MethodHandles$Lookup;->findVirtual(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/MethodHandle;

    move-result-object v5

    const-string v4, "accept"

    sget-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->l:Ljava/lang/invoke/MethodType;

    sget-object v7, Lcom/alibaba/fastjson2/util/TypeUtils;->v:Ljava/lang/invoke/MethodType;

    filled-new-array {v3}, [Ljava/lang/Class;

    move-result-object v3

    invoke-static {v2, v0, v3}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
...
.method public static k(Ljava/lang/Class;)Lcom/alibaba/fastjson2/writer/ObjectWriterPrimitiveImpl;
    ...
    invoke-static {v1}, Lcom/alibaba/fastjson2/support/LambdaMiscCodec;->i(Ljava/lang/reflect/Method;)Ljava/util/function/ToLongFunction;
    ...
    invoke-virtual {v6, p0, v3, v4}, Ljava/lang/invoke/MethodHandles$Lookup;->findVirtual(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v0, p0, v3}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    ...
    invoke-static {v1, p0}, Lcom/alibaba/fastjson2/writer/ObjectWriters;->e(Ljava/util/function/ToLongFunction;Ljava/util/function/BiFunction;)Lcom/alibaba/fastjson2/writer/ObjectWriter;
    ...
    sput-boolean p0, Lcom/alibaba/fastjson2/support/LambdaMiscCodec;->a:Z
