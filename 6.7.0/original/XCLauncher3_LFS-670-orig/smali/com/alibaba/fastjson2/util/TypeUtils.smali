...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->e:Ljava/lang/Class;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->f:Ljava/lang/Class;
    ...
    invoke-static {v2}, Ljava/util/Collections;->unmodifiableNavigableSet(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;

    move-result-object v2

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v2, Lcom/alibaba/fastjson2/util/ParameterizedTypeImpl;
    ...
    invoke-direct {v2, v4}, Lcom/alibaba/fastjson2/util/ParameterizedTypeImpl;-><init>([Ljava/lang/reflect/Type;)V

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->g:Lcom/alibaba/fastjson2/util/ParameterizedTypeImpl;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->h:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->i:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->j:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->k:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->l:Ljava/lang/invoke/MethodType;

    const-class v2, Ljava/util/function/IntFunction;

    invoke-static {v2}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v2

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->m:Ljava/lang/invoke/MethodType;

    const-class v2, Ljava/util/function/LongFunction;

    invoke-static {v2}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v2

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->n:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->o:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->p:Ljava/lang/invoke/MethodType;
    ...
    sput-object v5, Lcom/alibaba/fastjson2/util/TypeUtils;->q:Ljava/lang/invoke/MethodType;

    invoke-static {v4}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v5

    sput-object v5, Lcom/alibaba/fastjson2/util/TypeUtils;->r:Ljava/lang/invoke/MethodType;

    invoke-static {v4, v4}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v5

    sput-object v5, Lcom/alibaba/fastjson2/util/TypeUtils;->s:Ljava/lang/invoke/MethodType;
    ...
    sput-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->t:Ljava/lang/invoke/MethodType;

    sget-object v6, Ljava/lang/Long;->TYPE:Ljava/lang/Class;

    invoke-static {v6, v4}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v7

    sput-object v7, Lcom/alibaba/fastjson2/util/TypeUtils;->u:Ljava/lang/invoke/MethodType;

    filled-new-array {v5}, [Ljava/lang/Class;

    move-result-object v7

    invoke-static {v2, v4, v7}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v7

    sput-object v7, Lcom/alibaba/fastjson2/util/TypeUtils;->v:Ljava/lang/invoke/MethodType;

    invoke-static {v4, v6}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v7

    sput-object v7, Lcom/alibaba/fastjson2/util/TypeUtils;->w:Ljava/lang/invoke/MethodType;
    ...
    sput-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->x:Ljava/lang/invoke/MethodType;

    filled-new-array {v4}, [Ljava/lang/Class;

    move-result-object v6

    invoke-static {v4, v4, v6}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v6

    sput-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->y:Ljava/lang/invoke/MethodType;

    invoke-static {v2}, Ljava/lang/invoke/MethodType;->methodType(Ljava/lang/Class;)Ljava/lang/invoke/MethodType;

    move-result-object v6

    sput-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->z:Ljava/lang/invoke/MethodType;
    ...
    sput-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->A:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->C:Ljava/lang/invoke/MethodType;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->D:Ljava/math/BigInteger;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->E:Ljava/math/BigInteger;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->F:Ljava/math/BigInteger;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->G:Ljava/math/BigInteger;

    new-instance v2, Lcom/alibaba/fastjson2/util/TypeUtils$Cache;

    invoke-direct {v2}, Lcom/alibaba/fastjson2/util/TypeUtils$Cache;-><init>()V

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->H:Lcom/alibaba/fastjson2/util/TypeUtils$Cache;

    const-class v2, Lcom/alibaba/fastjson2/util/TypeUtils$Cache;

    const-class v3, [C

    const-string v5, "a"

    invoke-static {v2, v3, v5}, Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;->newUpdater(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    move-result-object v2

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->I:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    new-instance v2, Ljava/util/IdentityHashMap;

    invoke-direct {v2}, Ljava/util/IdentityHashMap;-><init>()V

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->J:Ljava/util/IdentityHashMap;

    new-instance v2, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v2}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->K:Ljava/util/concurrent/ConcurrentHashMap;

    const-string v2, "com.alibaba.fastjson.JSONObject"

    invoke-static {v2}, Lcom/alibaba/fastjson2/util/TypeUtils;->p(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->a:Ljava/lang/Class;
    ...
    :catchall_0
    :cond_0
    sput-object v5, Lcom/alibaba/fastjson2/util/TypeUtils;->b:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->c:Ljava/lang/Class;

    sget-object v2, Lcom/alibaba/fastjson2/util/TypeUtils;->J:Ljava/util/IdentityHashMap;
    ...
    invoke-virtual {v2, v3, v7}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lcom/alibaba/fastjson2/util/TypeUtils;->K:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v2, v9, v10}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v9, "java.util.concurrent.ConcurrentLinkedQueue"

    const-class v10, Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    const-string v9, "java.util.concurrent.ConcurrentLinkedDeque"

    const-class v11, Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    const-string v9, "HashSet"

    invoke-virtual {v2, v4, v9}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-class v9, Ljava/util/TreeSet;

    const-string v12, "TreeSet"

    invoke-virtual {v2, v9, v12}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-class v9, Ljava/util/LinkedHashSet;

    const-string v12, "LinkedHashSet"

    invoke-virtual {v2, v9, v12}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-class v12, Ljava/util/concurrent/ConcurrentHashMap;

    const-string v13, "ConcurrentHashMap"

    invoke-virtual {v2, v12, v13}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v12, "ConcurrentLinkedQueue"

    invoke-virtual {v2, v10, v12}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v10, "ConcurrentLinkedDeque"

    invoke-virtual {v2, v11, v10}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-class v10, Lcom/alibaba/fastjson2/JSONObject;

    const-string v11, "JSONObject"

    invoke-virtual {v2, v10, v11}, Ljava/util/IdentityHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-class v10, Lcom/alibaba/fastjson2/JSONArray;

    const-string v11, "JSONArray"
    ...
    const-class v10, Ljava/util/concurrent/TimeUnit;
    ...
    sget-object v12, Lcom/alibaba/fastjson2/util/TypeUtils;->K:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v12, Lcom/alibaba/fastjson2/util/TypeUtils;->J:Ljava/util/IdentityHashMap;
    ...
    const-string v10, "JO10"

    const-class v11, Lcom/alibaba/fastjson2/util/JSONObject1O;
    ...
    const-string v5, "StackTraceElement"
    ...
    const-string v5, "java.util.Collections$UnmodifiableCollection"
    ...
    invoke-static {v5}, Lcom/alibaba/fastjson2/util/TypeUtils;->p(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v5

    sget-object v6, Lcom/alibaba/fastjson2/util/TypeUtils;->K:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v1, Lcom/alibaba/fastjson2/util/TypeUtils;->K:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static D(Ljava/lang/Object;)Ljava/lang/Long;
    ...
    invoke-static {p0, v1}, Lcom/alibaba/fastjson2/a;->b(Ljava/lang/Object;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static F(Ljava/lang/Object;)Ljava/lang/Short;
    .locals 1
...
.method public static G(Ljava/lang/Object;)S
    .locals 2
...
.method public static I(BB)Ljava/lang/String;
    .locals 3
...
.method public static K(CC)Ljava/lang/String;
    .locals 3
...
.method public static L(ILjava/lang/String;)Z
    ...
    invoke-static {v5, v9, v10, v4}, Landroid/car/a;->z(IIII)I
...
.method public static M(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v0}, Lcom/alibaba/fastjson2/util/TypeUtils;->L(ILjava/lang/String;)Z
...
.method public static b(Ljava/lang/Object;Ljava/lang/Class;Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;)Ljava/lang/Object;
    ...
    const-string v6, "can not cast to Date from "
    ...
    invoke-static {p0, p2}, Lcom/alibaba/fastjson2/a;->b(Ljava/lang/Object;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :goto_3
    invoke-virtual {p0, v11}, Lcom/alibaba/fastjson2/JSONReader;->I0(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p0, v7, v8}, Lcom/alibaba/fastjson2/reader/ObjectReaderImplInstant;->p(Ljava/util/Map;J)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lcom/alibaba/fastjson2/util/TypeUtils;->B(Ljava/lang/Object;)I
    ...
    invoke-static {p0}, Lcom/alibaba/fastjson2/util/TypeUtils;->E(Ljava/lang/Object;)J
    ...
    invoke-virtual {p2, p1, v5}, Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;->i(Ljava/lang/reflect/Type;Z)Lcom/alibaba/fastjson2/reader/ObjectReader;

    move-result-object p1

    check-cast p0, Ljava/util/Map;

    invoke-interface {p1, p0, v7, v8}, Lcom/alibaba/fastjson2/reader/ObjectReader;->p(Ljava/util/Map;J)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v6, p1}, Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;->k(Ljava/lang/Class;Ljava/lang/reflect/Type;)Ljava/util/function/Function;

    move-result-object v6

    if-eqz v6, :cond_1a

    invoke-interface {v6, p0}, Ljava/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, v5}, Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;->i(Ljava/lang/reflect/Type;Z)Lcom/alibaba/fastjson2/reader/ObjectReader;
    ...
    invoke-interface/range {v6 .. v11}, Lcom/alibaba/fastjson2/reader/ObjectReader;->a(Lcom/alibaba/fastjson2/JSONReader;Ljava/lang/reflect/Type;Ljava/lang/Object;J)Ljava/lang/Object;
    ...
    invoke-virtual {v7, p1, v5}, Lcom/alibaba/fastjson2/reader/ObjectReaderProvider;->i(Ljava/lang/reflect/Type;Z)Lcom/alibaba/fastjson2/reader/ObjectReader;

    move-result-object v7

    instance-of v8, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum;

    if-eqz v8, :cond_26

    check-cast v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum;

    iget-object p0, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum;->d:Ljava/lang/reflect/Member;

    if-nez p0, :cond_20

    invoke-virtual {v7, v6}, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum;->x(I)Ljava/lang/Enum;
    ...
    iget-object p2, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum;->f:[Ljava/lang/Enum;
    ...
    invoke-static {v6, p1}, Landroid/car/a;->f(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum;->e:Ljava/lang/Class;
    ...
    :cond_26
    instance-of v8, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum2X4;

    if-eqz v8, :cond_29

    check-cast v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum2X4;
    ...
    :cond_27
    iget-object v4, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum2X4;->e:Ljava/lang/Enum;

    goto :goto_f

    :cond_28
    iget-object v4, v7, Lcom/alibaba/fastjson2/reader/ObjectReaderImplEnum2X4;->d:Ljava/lang/Enum;
    ...
    const-string v4, "create java.sql.Timestamp error"
    ...
    invoke-virtual {v0, v1, v1, v5}, Lcom/alibaba/fastjson2/writer/ObjectWriterProvider;->c(Ljava/lang/reflect/Type;Ljava/lang/Class;Z)Lcom/alibaba/fastjson2/writer/ObjectWriter;
    ...
    invoke-static {v0, p2, v1}, Landroid/car/a;->u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :try_start_2
    invoke-static {v0}, Lcom/alibaba/fastjson2/util/JdbcSupport;->c(Ljava/lang/String;)Ljava/util/function/LongFunction;
    ...
    invoke-interface {p0, v6, v7}, Ljava/util/function/LongFunction;->apply(J)Ljava/lang/Object;
    ...
    :try_start_3
    invoke-static {v1}, Lcom/alibaba/fastjson2/util/JdbcSupport;->c(Ljava/lang/String;)Ljava/util/function/LongFunction;
    ...
    :try_start_4
    invoke-static {v2}, Lcom/alibaba/fastjson2/util/JdbcSupport;->c(Ljava/lang/String;)Ljava/util/function/LongFunction;
...
.method public static e([CIIZ)D
    ...
    :cond_f
    sget-object v8, Lcom/alibaba/fastjson2/util/FloatingDecimal;->c:[D
    ...
    :cond_19
    sget-object v8, Lcom/alibaba/fastjson2/util/FloatingDecimal;->d:[D

    aget-wide v17, v8, v10

    mul-double v19, v3, v17

    cmpl-double v8, v19, v11
    ...
    invoke-direct/range {v3 .. v8}, Lcom/alibaba/fastjson2/util/FDBigInteger;-><init>(J[CII)V
    ...
    iput-boolean v9, v5, Lcom/alibaba/fastjson2/util/FDBigInteger;->d:Z
    ...
    invoke-static {v1, v2, v10, v11}, Lcom/alibaba/fastjson2/util/FDBigInteger;->m(IIJ)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    :cond_21
    invoke-virtual {v5, v12}, Lcom/alibaba/fastjson2/util/FDBigInteger;->e(I)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    :cond_22
    invoke-virtual {v2, v6}, Lcom/alibaba/fastjson2/util/FDBigInteger;->b(Lcom/alibaba/fastjson2/util/FDBigInteger;)I

    move-result v10

    if-lez v10, :cond_24

    invoke-virtual {v2, v6}, Lcom/alibaba/fastjson2/util/FDBigInteger;->d(Lcom/alibaba/fastjson2/util/FDBigInteger;)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    invoke-virtual {v2, v9}, Lcom/alibaba/fastjson2/util/FDBigInteger;->e(I)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    invoke-virtual {v6, v2}, Lcom/alibaba/fastjson2/util/FDBigInteger;->k(Lcom/alibaba/fastjson2/util/FDBigInteger;)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    :goto_b
    invoke-virtual {v2, v1, v15}, Lcom/alibaba/fastjson2/util/FDBigInteger;->c(II)I
...
.method public static f([CIIZ)F
    ...
    iput-boolean v10, v4, Lcom/alibaba/fastjson2/util/FDBigInteger;->d:Z
    ...
    invoke-static {v3, v2, v11, v12}, Lcom/alibaba/fastjson2/util/FDBigInteger;->m(IIJ)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    :cond_1b
    invoke-virtual {v4, v15}, Lcom/alibaba/fastjson2/util/FDBigInteger;->e(I)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    :cond_1c
    invoke-virtual {v2, v5}, Lcom/alibaba/fastjson2/util/FDBigInteger;->b(Lcom/alibaba/fastjson2/util/FDBigInteger;)I

    move-result v8

    if-lez v8, :cond_1e

    invoke-virtual {v2, v5}, Lcom/alibaba/fastjson2/util/FDBigInteger;->d(Lcom/alibaba/fastjson2/util/FDBigInteger;)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    invoke-virtual {v2, v10}, Lcom/alibaba/fastjson2/util/FDBigInteger;->e(I)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    invoke-virtual {v5, v2}, Lcom/alibaba/fastjson2/util/FDBigInteger;->k(Lcom/alibaba/fastjson2/util/FDBigInteger;)Lcom/alibaba/fastjson2/util/FDBigInteger;
    ...
    :goto_a
    invoke-virtual {v2, v3, v14}, Lcom/alibaba/fastjson2/util/FDBigInteger;->c(II)I
...
.method public static j(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {p0}, Lcom/alibaba/fastjson2/util/TypeUtils;->j(Ljava/lang/reflect/Type;)Ljava/lang/Class;
...
.method public static m(Ljava/math/BigInteger;)Z
    .locals 1
...
.method public static o(Ljava/lang/Class;)Z
    ...
    const-string v5, "org.springframework.context.annotation.ConfigurationClassEnhancer$EnhancedConfiguration"
    ...
    const-string v5, "org.mockito.cglib.proxy.Factory"
...
.method public static p(Ljava/lang/String;)Ljava/lang/Class;
    ...
    :cond_0
    sget-object v5, Lcom/alibaba/fastjson2/util/TypeUtils;->f:Ljava/lang/Class;
    ...
    :sswitch_4
    const-string v8, "ConcurrentHashMap"
    ...
    :sswitch_b
    const-string v8, "java.util.Collections$SingletonSet"
    ...
    :sswitch_c
    const-string v8, "java.util.Collections$UnmodifiableRandomAccessList"
    ...
    :sswitch_10
    const-string v8, "java.util.Arrays$ArrayList"
    ...
    :sswitch_11
    const-string v8, "java.util.OptionalLong"
    ...
    :sswitch_17
    const-string v8, "java.util.Collections$EmptyList"
    ...
    :sswitch_39
    const-string v8, "java.util.Collections$EmptySet"
    ...
    :sswitch_3a
    const-string v8, "java.util.Collections$EmptyMap"
    ...
    :sswitch_3c
    const-string v8, "java.util.Optional"
    ...
    :sswitch_3f
    const-string v8, "java.util.Collections$SingletonList"
    ...
    :sswitch_4b
    const-string v8, "ConcurrentLinkedQueue"
    ...
    :sswitch_4c
    const-string v8, "ConcurrentLinkedDeque"
    ...
    :sswitch_52
    const-string v8, "java.io.IOException"
...
.method public static q(Ljava/lang/Object;)Ljava/math/BigDecimal;
    .locals 2
...
.method public static r(Ljava/lang/String;)Ljava/math/BigDecimal;
    ...
    :goto_5
    invoke-static {v5, v6, v15}, Ljava/math/BigDecimal;->valueOf(JI)Ljava/math/BigDecimal;
    ...
    invoke-direct {v1, v0, v3, v2}, Ljava/math/BigDecimal;-><init>([CII)V
    ...
    :goto_d
    invoke-static {v12, v13, v15}, Ljava/math/BigDecimal;->valueOf(JI)Ljava/math/BigDecimal;
...
.method public static s(Ljava/lang/Object;)Ljava/math/BigInteger;
    .locals 2
...
.method public static v(Ljava/lang/Object;)Ljava/lang/Byte;
    .locals 1
...
.method public static x(Ljava/lang/Object;)Ljava/lang/Double;
    .locals 2
...
.method public static y(Ljava/lang/Object;)D
    .locals 3
...
.method public static z(Ljava/lang/Object;)Ljava/lang/Float;
    .locals 1
