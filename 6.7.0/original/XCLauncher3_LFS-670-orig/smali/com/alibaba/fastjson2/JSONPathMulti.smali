...
# direct methods
.method public varargs constructor <init>(Ljava/lang/String;Ljava/util/ArrayList;[Lcom/alibaba/fastjson2/JSONPath$Feature;)V
    .locals 5

    invoke-direct {p0, p1, p3}, Lcom/alibaba/fastjson2/JSONPath;-><init>(Ljava/lang/String;[Lcom/alibaba/fastjson2/JSONPath$Feature;)V

    iput-object p2, p0, Lcom/alibaba/fastjson2/JSONPathMulti;->e:Ljava/util/ArrayList;
...
.method public final a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/alibaba/fastjson2/JSONPathMulti;->e:Ljava/util/ArrayList;
    ...
    invoke-direct {v8, p0, v4, v5, v7}, Lcom/alibaba/fastjson2/JSONPath$Context;-><init>(Lcom/alibaba/fastjson2/JSONPath;Lcom/alibaba/fastjson2/JSONPath$Context;Lcom/alibaba/fastjson2/JSONPathSegment;Lcom/alibaba/fastjson2/JSONPathSegment;)V

    if-nez v3, :cond_2

    iput-object p1, v8, Lcom/alibaba/fastjson2/JSONPath$Context;->e:Ljava/lang/Object;

    :cond_2
    invoke-virtual {v5, v8}, Lcom/alibaba/fastjson2/JSONPathSegment;->b(Lcom/alibaba/fastjson2/JSONPath$Context;)V
    ...
    :cond_3
    iget-object p1, v4, Lcom/alibaba/fastjson2/JSONPath$Context;->f:Ljava/lang/Object;

    iget-object v0, v4, Lcom/alibaba/fastjson2/JSONPath$Context;->a:Lcom/alibaba/fastjson2/JSONPath;
...
.method public final b(Lcom/alibaba/fastjson2/JSONReader;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v1, p0, Lcom/alibaba/fastjson2/JSONPathMulti;->e:Ljava/util/ArrayList;
    ...
    invoke-direct {v8, p0, v5, v6, v7}, Lcom/alibaba/fastjson2/JSONPath$Context;-><init>(Lcom/alibaba/fastjson2/JSONPath;Lcom/alibaba/fastjson2/JSONPath$Context;Lcom/alibaba/fastjson2/JSONPathSegment;Lcom/alibaba/fastjson2/JSONPathSegment;)V

    if-eqz v4, :cond_4

    invoke-virtual {v6, v8}, Lcom/alibaba/fastjson2/JSONPathSegment;->b(Lcom/alibaba/fastjson2/JSONPath$Context;)V

    goto :goto_2

    :cond_4
    invoke-virtual {v6, p1, v8}, Lcom/alibaba/fastjson2/JSONPathSegment;->a(Lcom/alibaba/fastjson2/JSONReader;Lcom/alibaba/fastjson2/JSONPath$Context;)V

    :goto_2
    iget-boolean v5, v8, Lcom/alibaba/fastjson2/JSONPath$Context;->g:Z

    if-eqz v5, :cond_6

    iget-object v4, v8, Lcom/alibaba/fastjson2/JSONPath$Context;->f:Ljava/lang/Object;
    ...
    :cond_7
    :goto_3
    iget-object p1, v5, Lcom/alibaba/fastjson2/JSONPath$Context;->f:Ljava/lang/Object;
