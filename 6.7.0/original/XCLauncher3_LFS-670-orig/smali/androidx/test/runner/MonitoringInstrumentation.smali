...
.method public final c()V
    ...
    const-string v4, "Setting context classloader to \'%s\', Original: \'%s\'"
...
.method public final callActivityOnCreate(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, p1, v0}, Landroidx/test/internal/runner/lifecycle/ActivityLifecycleMonitorImpl;->c(Landroid/app/Activity;Landroidx/test/runner/lifecycle/Stage;)V
    ...
    invoke-virtual {v1, p1, p2}, Landroidx/test/internal/runner/lifecycle/ActivityLifecycleMonitorImpl;->c(Landroid/app/Activity;Landroidx/test/runner/lifecycle/Stage;)V
...
.method public final callActivityOnStart(Landroid/app/Activity;)V
    ...
    invoke-virtual {v1, p1, v2}, Landroidx/test/internal/runner/lifecycle/ActivityLifecycleMonitorImpl;->c(Landroid/app/Activity;Landroidx/test/runner/lifecycle/Stage;)V
    :try_end_0
...
.method public final finish(ILandroid/os/Bundle;)V
    ...
    const-string/jumbo v2, "waitForActivitiesToComplete"
    ...
    const-string v8, "Unstopped activity count: "
    ...
    sget-wide v7, Landroidx/test/runner/MonitoringInstrumentation;->o:J
    ...
    const-string v2, "Abandoning activity wait due to interruption."
...
.method public final onStart()V
    ...
    invoke-virtual {v0, p0, v1}, Landroidx/test/internal/runner/InstrumentationConnection;->a(Landroidx/test/runner/MonitoringInstrumentation;Landroidx/test/runner/MonitoringInstrumentation$ActivityFinisher;)V
...
.method public final startActivitySync(Landroid/content/Intent;)Landroid/app/Activity;
    ...
    new-instance v4, Landroidx/test/runner/MonitoringInstrumentation$4;

    invoke-direct {v4, p0, p1}, Landroidx/test/runner/MonitoringInstrumentation$4;-><init>(Landroidx/test/runner/MonitoringInstrumentation;Landroid/content/Intent;)V
    ...
    filled-new-array {p1, v4, v1, v0}, [Ljava/lang/Object;
