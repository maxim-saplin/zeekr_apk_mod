...
.method public final D(Landroidx/appcompat/view/ActionMode$Callback;)Landroidx/appcompat/view/ActionMode;
    ...
    invoke-static {p1}, Landroidx/core/view/ViewCompat;->W(Landroid/view/View;)V
...
.method public final E(ZZ)Z
    ...
    invoke-static {v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->G(Landroid/content/Context;)Landroidx/core/os/LocaleListCompat;
    ...
    :cond_3
    invoke-static {v2, v3, v5, v6, v1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->K(Landroid/content/Context;ILandroidx/core/os/LocaleListCompat;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;

    move-result-object p2

    iget-boolean v7, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->b0:Z

    iget-object v8, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->j:Ljava/lang/Object;
    ...
    :cond_6
    :goto_3
    iput-boolean v9, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->b0:Z
    ...
    invoke-virtual {p1, v6, v9}, Landroid/content/res/Resources$Theme;->applyStyle(IZ)V
    ...
    instance-of p1, v8, Landroidx/appcompat/app/AppCompatActivity;
    ...
    invoke-virtual {v8, v5}, Landroidx/appcompat/app/AppCompatActivity;->onLocalesChanged(Landroidx/core/os/LocaleListCompat;)V
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->P(Landroid/content/Context;)Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
...
.method public final F(Landroid/view/Window;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->m0:Landroid/window/OnBackInvokedCallback;
    ...
    :cond_2
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->l0:Landroid/window/OnBackInvokedDispatcher;
...
.method public final N()V
    ...
    invoke-static {v2, v3}, Landroidx/core/view/ViewCompat;->m0(Landroid/view/View;Landroidx/core/view/OnApplyWindowInsetsListener;)V
    ...
    iput-boolean v6, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->e0:Z
...
.method public final Q(I)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    :cond_1
    iput-object v2, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->R:[Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method public final S(Landroid/content/Context;I)I
    ...
    :cond_3
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->P(Landroid/content/Context;)Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
...
.method public final U(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {v3, v6}, Landroidx/appcompat/view/menu/ListMenuPresenter;->c(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/MenuView;
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->Y()V
...
.method public final e(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iget-object v5, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->k0:Landroidx/appcompat/app/AppCompatViewInflater;

    const/4 v6, 0x0

    if-nez v5, :cond_1

    sget-object v5, Landroidx/appcompat/R$styleable;->j:[I
    ...
    new-instance v5, Landroidx/appcompat/app/AppCompatViewInflater;

    invoke-direct {v5}, Landroidx/appcompat/app/AppCompatViewInflater;-><init>()V

    iput-object v5, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->k0:Landroidx/appcompat/app/AppCompatViewInflater;
    ...
    check-cast v7, Landroidx/appcompat/app/AppCompatViewInflater;

    iput-object v7, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->k0:Landroidx/appcompat/app/AppCompatViewInflater;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v8, v5, v7}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    sget v7, Landroidx/appcompat/widget/VectorEnabledTintResources;->a:I

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v7, Landroidx/appcompat/R$styleable;->z:[I

    invoke-virtual {p2, p3, v7, v3, v3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    instance-of v7, p2, Landroidx/appcompat/view/ContextThemeWrapper;

    if-eqz v7, :cond_3

    move-object v7, p2

    check-cast v7, Landroidx/appcompat/view/ContextThemeWrapper;

    iget v7, v7, Landroidx/appcompat/view/ContextThemeWrapper;->a:I
    ...
    invoke-direct {v7, p2, v8}, Landroidx/appcompat/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V
    ...
    :pswitch_0
    invoke-virtual {v5, v7, p3}, Landroidx/appcompat/app/AppCompatViewInflater;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatEditText;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    :pswitch_2
    invoke-virtual {v5, v7, p3}, Landroidx/appcompat/app/AppCompatViewInflater;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    :pswitch_3
    invoke-virtual {v5, v7, p3}, Landroidx/appcompat/app/AppCompatViewInflater;->a(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatImageView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatToggleButton;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    :pswitch_6
    invoke-virtual {v5, v7, p3}, Landroidx/appcompat/app/AppCompatViewInflater;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    invoke-direct {v2, v7, p3, v8}, Landroidx/appcompat/widget/AppCompatSpinner;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatSeekBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatImageButton;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    :pswitch_a
    invoke-virtual {v5, v7, p3}, Landroidx/appcompat/app/AppCompatViewInflater;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatCheckedTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v7, p3}, Landroidx/appcompat/widget/AppCompatRatingBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object p2, v5, Landroidx/appcompat/app/AppCompatViewInflater;->a:[Ljava/lang/Object;
    ...
    invoke-interface {p3, v6, p1}, Landroid/util/AttributeSet;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v7, p1, v2}, Landroidx/appcompat/app/AppCompatViewInflater;->f(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_16
    :try_start_2
    invoke-virtual {v5, v7, p1, v6}, Landroidx/appcompat/app/AppCompatViewInflater;->f(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-direct {v0, v2, p2}, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;-><init>(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, p3, p1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v2, p2}, Landroidx/core/view/ViewCompat;->Z(Landroid/view/View;Z)V
    ...
    invoke-static {v2, p2}, Landroidx/core/view/ViewCompat;->b0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final p()V
    ...
    invoke-static {v1, v2}, Landroidx/core/app/NavUtils;->c(Landroid/app/Activity;Landroid/content/ComponentName;)Ljava/lang/String;
