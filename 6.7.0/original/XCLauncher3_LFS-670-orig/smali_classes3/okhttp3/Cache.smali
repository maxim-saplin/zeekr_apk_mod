...
.method public static j(Lokhttp3/Response;Lokhttp3/Response;)V
    .locals 3
    ...
    invoke-virtual {p0, v1, v2, p1}, Lokhttp3/internal/cache/DiskLruCache;->j(JLjava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Editor;
...
.method public final c(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v3, v1}, Lokhttp3/internal/cache/DiskLruCache;->m(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    iget-object v4, v1, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v10, v4}, Lokhttp3/Request$Builder;->e(Lokhttp3/Headers;)V
    ...
    iget-object v12, v3, Lokhttp3/Cache$Entry;->d:Lokhttp3/Protocol;

    invoke-static {v12, v10}, Lkotlin/jvm/internal/Intrinsics;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v12, v11, Lokhttp3/Response$Builder;->b:Lokhttp3/Protocol;
    ...
    iget-object v12, v3, Lokhttp3/Cache$Entry;->f:Ljava/lang/String;

    invoke-static {v12, v10}, Lkotlin/jvm/internal/Intrinsics;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v12, v11, Lokhttp3/Response$Builder;->d:Ljava/lang/String;

    invoke-virtual {v11, v8}, Lokhttp3/Response$Builder;->c(Lokhttp3/Headers;)V
    ...
    invoke-virtual {v6, v0}, Lokhttp3/HttpUrl;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v3}, Lokhttp3/Headers;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v5

    iget-object v6, p1, Lokhttp3/Request;->c:Lokhttp3/Headers;

    invoke-virtual {v6, v3}, Lokhttp3/Headers;->f(Ljava/lang/String;)Ljava/util/List;
...
.method public final f(Lokhttp3/Response;)Lokhttp3/internal/cache/CacheRequest;
    ...
    invoke-virtual {v0}, Lokhttp3/internal/cache/DiskLruCache;->n()V
    ...
    :cond_0
    :try_start_3
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache;->w(Lokhttp3/internal/cache/DiskLruCache$Entry;)V
    ...
    iput-boolean p1, v0, Lokhttp3/internal/cache/DiskLruCache;->n:Z
    :try_end_3
    ...
    sget-wide v4, Lokhttp3/internal/cache/DiskLruCache;->x:J

    invoke-virtual {p1, v4, v5, v0}, Lokhttp3/internal/cache/DiskLruCache;->j(JLjava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Editor;
