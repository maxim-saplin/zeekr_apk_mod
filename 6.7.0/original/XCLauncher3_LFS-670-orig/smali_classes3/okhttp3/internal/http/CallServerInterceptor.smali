...
.method public final a(Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/Response;
    ...
    invoke-interface {v7, v9}, Lokhttp3/internal/http/ExchangeCodec;->h(Lokhttp3/Request;)V
    ...
    :try_start_3
    invoke-interface {v7}, Lokhttp3/internal/http/ExchangeCodec;->d()V
    :try_end_3
    ...
    :try_start_6
    invoke-virtual {v5, v6, v12}, Lokhttp3/EventListener;->s(Lokhttp3/Call;Ljava/io/IOException;)V
    ...
    invoke-virtual {v0, v14}, Lokhttp3/RequestBody;->e(Lokio/BufferedSink;)V
    ...
    :try_start_8
    invoke-virtual {v6, v4, v14, v12, v15}, Lokhttp3/internal/connection/RealCall;->g(Lokhttp3/internal/connection/Exchange;ZZLjava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-interface {v7}, Lokhttp3/internal/http/ExchangeCodec;->b()Lokhttp3/internal/connection/RealConnection;
    ...
    :try_start_9
    invoke-virtual {v6, v4, v14, v13, v12}, Lokhttp3/internal/connection/RealCall;->g(Lokhttp3/internal/connection/Exchange;ZZLjava/io/IOException;)Ljava/io/IOException;
    :try_end_9
    ...
    :goto_6
    :try_start_a
    invoke-interface {v7}, Lokhttp3/internal/http/ExchangeCodec;->a()V
    :try_end_a
    ...
    :try_start_b
    invoke-virtual {v5, v6, v13}, Lokhttp3/EventListener;->s(Lokhttp3/Call;Ljava/io/IOException;)V

    invoke-virtual {v4, v13}, Lokhttp3/internal/connection/Exchange;->f(Ljava/io/IOException;)V
    ...
    iget-boolean v13, v4, Lokhttp3/internal/connection/Exchange;->e:Z
    ...
    :try_start_d
    invoke-virtual {v4, v13}, Lokhttp3/internal/connection/Exchange;->e(Z)Lokhttp3/Response$Builder;
    ...
    iget-object v13, v8, Lokhttp3/internal/connection/RealConnection;->e:Lokhttp3/Handshake;
    ...
    iget-object v8, v8, Lokhttp3/internal/connection/RealConnection;->e:Lokhttp3/Handshake;

    iput-object v8, v0, Lokhttp3/Response$Builder;->e:Lokhttp3/Handshake;
    ...
    :try_start_e
    iget-boolean v6, v5, Lokhttp3/internal/http/CallServerInterceptor;->a:Z
    ...
    invoke-virtual {v1}, Lokhttp3/ResponseBody;->f()J
    ...
    invoke-static {v15, v0}, Lkotlin/ExceptionsKt;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
