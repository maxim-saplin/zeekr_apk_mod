...
.method public final g(Lokio/Path;)Lokio/FileMetadata;
    ...
    :cond_1
    iget-wide v4, p1, Lokio/internal/ZipEntry;->d:J
    ...
    invoke-virtual {p1, v3}, Lokio/FileSystem;->h(Lokio/Path;)Lokio/FileHandle;

    move-result-object p1

    :try_start_0
    invoke-virtual {p1, v1, v2}, Lokio/FileHandle;->n(J)Lokio/Source;
...
.method public final j(Lokio/Path;)Lokio/Source;
    ...
    invoke-virtual {p1, v2}, Lokio/FileSystem;->h(Lokio/Path;)Lokio/FileHandle;
    ...
    invoke-virtual {p1, v3, v4}, Lokio/FileHandle;->n(J)Lokio/Source;
...
.method public final k(Lokio/Path;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Lokio/ZipFileSystem;->d:Ljava/util/LinkedHashMap;
