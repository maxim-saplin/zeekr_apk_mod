...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcopy/okhttp3/Dispatcher;->b:Ljava/util/ArrayDeque;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcopy/okhttp3/Dispatcher;->c:Ljava/util/ArrayDeque;
...
.method public final a(Ljava/util/ArrayDeque;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lcopy/okhttp3/Dispatcher;->c()V
...
.method public final b(Lcopy/okhttp3/internal/connection/RealCall$AsyncCall;)V
    .locals 1
    ...
    iget-object v0, p0, Lcopy/okhttp3/Dispatcher;->c:Ljava/util/ArrayDeque;

    invoke-virtual {p0, v0, p1}, Lcopy/okhttp3/Dispatcher;->a(Ljava/util/ArrayDeque;Ljava/lang/Object;)V
...
.method public final c()V
    ...
    :try_start_0
    iget-object v1, p0, Lcopy/okhttp3/Dispatcher;->b:Ljava/util/ArrayDeque;
    ...
    iget-object v3, p0, Lcopy/okhttp3/Dispatcher;->c:Ljava/util/ArrayDeque;
    ...
    :try_start_1
    iget-object v1, p0, Lcopy/okhttp3/Dispatcher;->c:Ljava/util/ArrayDeque;
    ...
    :try_start_3
    iget-object v5, p0, Lcopy/okhttp3/Dispatcher;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-static {v6, v2}, Lcopy/okhttp3/internal/Util;->u(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    iput-object v5, p0, Lcopy/okhttp3/Dispatcher;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-virtual {v6, v7}, Lcopy/okhttp3/internal/connection/RealCall;->k(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {v5, v4}, Lcopy/okhttp3/Dispatcher;->b(Lcopy/okhttp3/internal/connection/RealCall$AsyncCall;)V
    ...
    invoke-virtual {v1, v4}, Lcopy/okhttp3/Dispatcher;->b(Lcopy/okhttp3/internal/connection/RealCall$AsyncCall;)V
