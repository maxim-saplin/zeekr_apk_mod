...
.method public constructor <init>(Lcopy/okio/Buffer;)V
    ...
    iput-object p1, p0, Lcopy/okhttp3/internal/http2/Hpack$Writer;->h:Lcopy/okio/Buffer;
...
.method public final c(Lcopy/okio/ByteString;)V
    ...
    iget-object v1, p0, Lcopy/okhttp3/internal/http2/Hpack$Writer;->h:Lcopy/okio/Buffer;
    ...
    invoke-virtual {p1, v6}, Lcopy/okio/ByteString;->g(I)B
    ...
    invoke-virtual {p1, v3}, Lcopy/okio/ByteString;->g(I)B
    ...
    sget-object v10, Lcopy/okhttp3/internal/http2/Huffman;->a:[I

    aget v10, v10, v5

    sget-object v11, Lcopy/okhttp3/internal/http2/Huffman;->b:[B
    ...
    invoke-virtual {v2, v5}, Lcopy/okio/Buffer;->X(I)V
    ...
    invoke-virtual {v2, p1}, Lcopy/okio/Buffer;->X(I)V

    :cond_3
    iget-wide v3, v2, Lcopy/okio/Buffer;->b:J

    invoke-virtual {v2, v3, v4}, Lcopy/okio/Buffer;->y(J)Lcopy/okio/ByteString;
    ...
    invoke-virtual {p0, v0, v7, v2}, Lcopy/okhttp3/internal/http2/Hpack$Writer;->e(III)V

    invoke-virtual {v1, p1}, Lcopy/okio/Buffer;->V(Lcopy/okio/ByteString;)V
    ...
    invoke-virtual {p0, v0, v7, v3}, Lcopy/okhttp3/internal/http2/Hpack$Writer;->e(III)V
...
.method public final d(Ljava/util/ArrayList;)V
    ...
    sget-object v9, Lcopy/okhttp3/internal/http2/Hpack;->a:[Lcopy/okhttp3/internal/http2/Header;

    aget-object v10, v9, v5

    iget-object v10, v10, Lcopy/okhttp3/internal/http2/Header;->c:Lcopy/okio/ByteString;
    ...
    sget-object v8, Lcopy/okhttp3/internal/http2/Hpack;->c:Lcopy/okhttp3/internal/http2/Hpack;
    ...
    invoke-virtual {p0, v8, v3, v4}, Lcopy/okhttp3/internal/http2/Hpack$Writer;->e(III)V
    ...
    iget-object v5, p0, Lcopy/okhttp3/internal/http2/Hpack$Writer;->h:Lcopy/okio/Buffer;

    invoke-virtual {v5, v8}, Lcopy/okio/Buffer;->X(I)V
    ...
    invoke-virtual {v4, v9, v6}, Lcopy/okio/ByteString;->n(ILcopy/okio/ByteString;)Z
    ...
    invoke-virtual {p0, v5, v3, v1}, Lcopy/okhttp3/internal/http2/Hpack$Writer;->e(III)V
    ...
    invoke-virtual {p0, v5, v4, v8}, Lcopy/okhttp3/internal/http2/Hpack$Writer;->e(III)V
...
.method public final e(III)V
    ...
    iget-object v0, p0, Lcopy/okhttp3/internal/http2/Hpack$Writer;->h:Lcopy/okio/Buffer;

    if-ge p1, p2, :cond_0

    or-int/2addr p1, p3

    invoke-virtual {v0, p1}, Lcopy/okio/Buffer;->X(I)V
    ...
    invoke-virtual {v0, p3}, Lcopy/okio/Buffer;->X(I)V
    ...
    invoke-virtual {v0, p2}, Lcopy/okio/Buffer;->X(I)V
