...
.field public final e:Lcopy/okio/RealBufferedSource;

.field public final f:Lcopy/okio/RealBufferedSink;
...
.method public constructor <init>(Lcopy/okhttp3/OkHttpClient;Lcopy/okhttp3/internal/connection/RealConnection;Lcopy/okio/RealBufferedSource;Lcopy/okio/RealBufferedSink;)V
    .locals 1
    ...
    .param p3    # Lcopy/okio/RealBufferedSource;
        ...
        .end annotation
    .end param
    .param p4    # Lcopy/okio/RealBufferedSink;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object p3, p0, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->e:Lcopy/okio/RealBufferedSource;

    iput-object p4, p0, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->f:Lcopy/okio/RealBufferedSink;

    new-instance p1, Lcopy/okhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lcopy/okhttp3/internal/http1/HeadersReader;-><init>(Lcopy/okio/RealBufferedSource;)V
...
.method public static final i(Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;Lcopy/okio/ForwardingTimeout;)V
    .locals 2
...
.method public final a()V
    ...
    iget-object v0, p0, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->f:Lcopy/okio/RealBufferedSink;
...
.method public final c(Z)Lcopy/okhttp3/Response$Builder;
    ...
    invoke-virtual {v2, v4, v5}, Lcopy/okio/RealBufferedSource;->r(J)Ljava/lang/String;
    ...
    iput v2, v4, Lcopy/okhttp3/Response$Builder;->c:I
    ...
    :goto_1
    iget-object v5, v0, Lcopy/okhttp3/internal/http1/HeadersReader;->b:Lcopy/okio/RealBufferedSource;

    iget-wide v6, v0, Lcopy/okhttp3/internal/http1/HeadersReader;->a:J

    invoke-virtual {v5, v6, v7}, Lcopy/okio/RealBufferedSource;->r(J)Ljava/lang/String;
    ...
    iput-wide v6, v0, Lcopy/okhttp3/internal/http1/HeadersReader;->a:J
    ...
    iput v3, p0, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->a:I
...
.method public final e(Lcopy/okhttp3/Request;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->l(Lcopy/okhttp3/Headers;Ljava/lang/String;)V
...
.method public final f(Lcopy/okhttp3/Response;)Lcopy/okio/Source;
    ...
    invoke-virtual {p0, v0, v1}, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->j(J)Lcopy/okio/Source;
    ...
    invoke-virtual {p0, v4, v5}, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;->j(J)Lcopy/okio/Source;
    ...
    invoke-direct {p1, p0}, Lcopy/okhttp3/internal/http1/Http1ExchangeCodec$AbstractSource;-><init>(Lcopy/okhttp3/internal/http1/Http1ExchangeCodec;)V
...
.method public final j(J)Lcopy/okio/Source;
    .locals 2
...
.method public final k(Lcopy/okhttp3/Response;)V
    .locals 4
    .param p1    # Lcopy/okhttp3/Response;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p1, v0, v1}, Lcopy/okhttp3/internal/Util;->t(Lcopy/okio/Source;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final l(Lcopy/okhttp3/Headers;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-virtual {v0, p2}, Lcopy/okio/RealBufferedSink;->b(Ljava/lang/String;)Lcopy/okio/BufferedSink;

    const-string p2, "\r\n"

    invoke-virtual {v0, p2}, Lcopy/okio/RealBufferedSink;->b(Ljava/lang/String;)Lcopy/okio/BufferedSink;

    invoke-virtual {p1}, Lcopy/okhttp3/Headers;->size()I
    ...
    invoke-virtual {p1, v2}, Lcopy/okhttp3/Headers;->c(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v2}, Lcopy/okhttp3/Headers;->e(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v0, v3}, Lcopy/okio/BufferedSink;->b(Ljava/lang/String;)Lcopy/okio/BufferedSink;

    invoke-interface {v0, p2}, Lcopy/okio/BufferedSink;->b(Ljava/lang/String;)Lcopy/okio/BufferedSink;
