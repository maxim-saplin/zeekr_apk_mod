...
.method public static a(Lcopy/okhttp3/HttpUrl$Companion;Ljava/lang/String;IILjava/lang/String;I)Ljava/lang/String;
    .locals 17
    ...
    invoke-static {v6, v4, v0}, Lcopy/okhttp3/HttpUrl$Companion;->c(IILjava/lang/String;)Z
    ...
    invoke-virtual {v9, v2, v6, v0}, Lcopy/okio/Buffer;->c0(IILjava/lang/String;)V
    ...
    :goto_9
    invoke-virtual {v9, v13}, Lcopy/okio/Buffer;->d0(Ljava/lang/String;)V
    ...
    :cond_e
    invoke-virtual {v9, v15}, Lcopy/okio/Buffer;->e0(I)V
    ...
    :cond_11
    invoke-virtual {v2, v15}, Lcopy/okio/Buffer;->e0(I)V

    :goto_c
    invoke-virtual {v2}, Lcopy/okio/Buffer;->E()Z

    move-result v13

    if-nez v13, :cond_f

    invoke-virtual {v2}, Lcopy/okio/Buffer;->w()B
    ...
    invoke-virtual {v9, v11}, Lcopy/okio/Buffer;->X(I)V

    sget-object v16, Lcopy/okhttp3/HttpUrl;->j:[C
    ...
    invoke-virtual {v9, v10}, Lcopy/okio/Buffer;->X(I)V
...
.method public static d(Lcopy/okhttp3/HttpUrl$Companion;Ljava/lang/String;III)Ljava/lang/String;
    .locals 7
    ...
    :cond_4
    :goto_2
    new-instance p4, Lcopy/okio/Buffer;

    invoke-direct {p4}, Lcopy/okio/Buffer;-><init>()V

    invoke-virtual {p4, p2, p0, p1}, Lcopy/okio/Buffer;->c0(IILjava/lang/String;)V
    ...
    invoke-static {v5}, Lcopy/okhttp3/internal/Util;->p(C)I
    ...
    invoke-virtual {p4, p0}, Lcopy/okio/Buffer;->X(I)V
    ...
    invoke-virtual {p4, p2}, Lcopy/okio/Buffer;->X(I)V
    ...
    :cond_6
    invoke-virtual {p4, p2}, Lcopy/okio/Buffer;->e0(I)V
    ...
    :cond_7
    invoke-virtual {p4}, Lcopy/okio/Buffer;->K()Ljava/lang/String;
...
.method public static f(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)V
    .locals 6
