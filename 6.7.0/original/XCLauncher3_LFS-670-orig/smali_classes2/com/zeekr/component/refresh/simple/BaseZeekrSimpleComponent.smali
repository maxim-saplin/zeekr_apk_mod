...
# virtual methods
.method public final a(Lcom/zeekr/component/refresh/ZeekrRefreshLayout;II)V
    .locals 1
    .param p1    # Lcom/zeekr/component/refresh/ZeekrRefreshLayout;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/zeekr/component/refresh/api/ZeekrRefreshComponent;->a(Lcom/zeekr/component/refresh/ZeekrRefreshLayout;II)V

    :cond_0
    return-void
.end method

.method public final b(Lcom/zeekr/component/refresh/api/ZeekrRefreshLayout;II)V
    .locals 1
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/zeekr/component/refresh/api/ZeekrRefreshComponent;->b(Lcom/zeekr/component/refresh/api/ZeekrRefreshLayout;II)V
...
.method public final d(Lcom/zeekr/component/refresh/api/ZeekrRefreshLayout;Z)I
    .locals 1
    .param p1    # Lcom/zeekr/component/refresh/api/ZeekrRefreshLayout;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-interface {v0, p1, p2}, Lcom/zeekr/component/refresh/api/ZeekrRefreshComponent;->d(Lcom/zeekr/component/refresh/api/ZeekrRefreshLayout;Z)I
...
.method public final e(IIIFZ)V
    ...
    invoke-interface/range {v0 .. v5}, Lcom/zeekr/component/refresh/api/ZeekrRefreshComponent;->e(IIIFZ)V
...
.method public final h(Lcom/zeekr/component/refresh/ZeekrRefreshLayout$ZeekrRefreshKernelImpl;II)V
    ...
    iget-object p3, p1, Lcom/zeekr/component/refresh/ZeekrRefreshLayout;->A0:Landroid/graphics/Paint;
    ...
    iput-object p3, p1, Lcom/zeekr/component/refresh/ZeekrRefreshLayout;->A0:Landroid/graphics/Paint;

    :cond_1
    iget-object p3, p1, Lcom/zeekr/component/refresh/ZeekrRefreshLayout;->x0:Lcom/zeekr/component/refresh/api/ZeekrRefreshHeader;

    invoke-virtual {p0, p3}, Lcom/zeekr/component/refresh/simple/BaseZeekrSimpleComponent;->equals(Ljava/lang/Object;)Z

    move-result p3

    if-eqz p3, :cond_2

    iput p2, p1, Lcom/zeekr/component/refresh/ZeekrRefreshLayout;->G0:I

    goto :goto_0

    :cond_2
    iget-object p3, p1, Lcom/zeekr/component/refresh/ZeekrRefreshLayout;->y0:Lcom/zeekr/component/refresh/api/ZeekrRefreshFooter;
    ...
    iput p2, p1, Lcom/zeekr/component/refresh/ZeekrRefreshLayout;->H0:I
