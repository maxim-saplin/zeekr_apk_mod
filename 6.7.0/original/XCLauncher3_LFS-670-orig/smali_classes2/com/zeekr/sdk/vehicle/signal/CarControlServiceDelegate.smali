...
.method private final callbackData(Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v2, v1, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;

    if-eqz v2, :cond_0

    move-object v2, v1

    check-cast v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;

    iget v3, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->label:I
    ...
    iput v3, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->label:I
    ...
    :cond_0
    new-instance v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;

    move-object/from16 v3, p0

    invoke-direct {v2, v3, v1}, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;-><init>(Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object v1, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->result:Ljava/lang/Object;

    sget-object v4, Lkotlin/coroutines/intrinsics/CoroutineSingletons;->a:Lkotlin/coroutines/intrinsics/CoroutineSingletons;

    iget v5, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->label:I
    ...
    :pswitch_0
    iget-object v0, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->L$1:Ljava/lang/Object;

    check-cast v0, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;

    iget-object v2, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->L$0:Ljava/lang/Object;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate;->getMDataSet()Ljava/util/Set;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getFunctionId()I

    move-result v8

    if-ne v7, v8, :cond_1

    invoke-virtual {v6}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getZone()I

    move-result v6

    invoke-virtual/range {p1 .. p1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getZone()I
    ...
    check-cast v1, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;
    ...
    const-string v1, "callback find functionId: "
    ...
    invoke-static {v5, v0}, Lcom/zeekr/sdk/base/utils/LogHelper;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-virtual/range {p1 .. p1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getValue()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getValue()Ljava/lang/Object;
    ...
    const-string v12, ", int value: "

    if-eqz v7, :cond_5

    invoke-static {v11}, Lcom/zeekr/sdk/vehicle/b;->a(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v5, v6}, Lcom/zeekr/sdk/base/utils/LogHelper;->i(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct/range {p0 .. p0}, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate;->getMFlow()Lkotlinx/coroutines/flow/MutableSharedFlow;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getType()I
    ...
    invoke-virtual {v1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getFunctionStatus()Lcom/zeekr/sdk/vehicle/agreement/bean/FunctionState;

    move-result-object v16

    move-object v11, v6

    invoke-direct/range {v11 .. v16}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlDataWrapper;-><init>(IIILjava/lang/Object;Lcom/zeekr/sdk/vehicle/agreement/bean/FunctionState;)V

    invoke-virtual {v6, v10}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlDataWrapper;->setSame(Z)V

    iput v10, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->label:I
    ...
    invoke-direct/range {v9 .. v14}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlDataWrapper;-><init>(IIILjava/lang/Object;Lcom/zeekr/sdk/vehicle/agreement/bean/FunctionState;)V

    invoke-virtual {v6, v8}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlDataWrapper;->setSame(Z)V

    iput-object v0, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->L$0:Ljava/lang/Object;

    iput-object v1, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->L$1:Ljava/lang/Object;

    const/4 v7, 0x2

    iput v7, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->label:I
    ...
    :cond_6
    :goto_3
    const-string v2, "null cannot be cast to non-null type com.zeekr.sdk.vehicle.signal.data.CarControlData<kotlin.Int>"
    ...
    invoke-virtual {v1, v0}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->setValue(Ljava/lang/Object;)V
    ...
    iput v0, v2, Lcom/zeekr/sdk/vehicle/signal/CarControlServiceDelegate$callbackData$1;->label:I
    ...
    :cond_a
    :goto_5
    const-string v2, "null cannot be cast to non-null type com.zeekr.sdk.vehicle.signal.data.CarControlData<kotlin.Float>"
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->getFunctionStatus()Lcom/zeekr/sdk/vehicle/agreement/bean/FunctionState;
    ...
    const-string v13, ", functionStatus: "
    ...
    invoke-virtual {v1, v0}, Lcom/zeekr/sdk/vehicle/signal/data/CarControlData;->setFunctionStatus(Lcom/zeekr/sdk/vehicle/agreement/bean/FunctionState;)V
...
.method public final collectCallbackFlow(Lkotlin/coroutines/CoroutineContext;Ljava/util/List;Ljava/util/List;ZLkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {v0, p2, p2, v9, p1}, Lkotlinx/coroutines/BuildersKt;->c(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/Job;
