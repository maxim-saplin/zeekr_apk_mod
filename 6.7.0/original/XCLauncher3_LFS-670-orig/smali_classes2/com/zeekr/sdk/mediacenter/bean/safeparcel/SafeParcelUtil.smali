...
.method private static readField(Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable;Landroid/os/Parcel;Ljava/lang/reflect/Field;I)V
    ...
    const-class v1, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable$Field;
    ...
    check-cast v1, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable$Field;

    invoke-interface {v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable$Field;->versionCode()J
    ...
    invoke-static {v5}, Lcom/zeekr/sdk/mediacenter/i;->a(I)I
    ...
    invoke-static {p1}, Lcom/zeekr/sdk/mediacenter/e;->a(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/a;->a(I)Ljava/lang/String;
    ...
    :pswitch_0
    invoke-static {p2}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelUtil;->getSubClass(Ljava/lang/reflect/Field;)Ljava/lang/Class;

    move-result-object v1

    invoke-static {v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelUtil;->getClassLoader(Ljava/lang/Class;)Ljava/lang/ClassLoader;

    move-result-object v1

    invoke-static {p1, p3, v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readMap(Landroid/os/Parcel;ILjava/lang/ClassLoader;)Ljava/util/HashMap;
    ...
    :pswitch_1
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readString(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_2
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readDouble(Landroid/os/Parcel;I)D
    ...
    :pswitch_3
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readFloat(Landroid/os/Parcel;I)F
    ...
    :pswitch_4
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readBool(Landroid/os/Parcel;I)Z
    ...
    :pswitch_5
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readLong(Landroid/os/Parcel;I)J
    ...
    :pswitch_6
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readInt(Landroid/os/Parcel;I)I
    ...
    :pswitch_7
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readIntArray(Landroid/os/Parcel;I)[I
    ...
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readBinder(Landroid/os/Parcel;I)Landroid/os/IBinder;
    ...
    :pswitch_9
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readByteArray(Landroid/os/Parcel;I)[B
    ...
    :pswitch_a
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readStringArray(Landroid/os/Parcel;I)[Ljava/lang/String;
    ...
    :pswitch_b
    invoke-static {p2}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelUtil;->getCreator(Ljava/lang/reflect/Field;)Landroid/os/Parcelable$Creator;

    move-result-object v1

    invoke-static {p1, p3, v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readParcelableArray(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Landroid/os/Parcelable;
    ...
    invoke-static {p1, p3, v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readBundle(Landroid/os/Parcel;ILjava/lang/ClassLoader;)Landroid/os/Bundle;
    ...
    :cond_6
    invoke-static {v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelUtil;->getCreator(Ljava/lang/Class;)Landroid/os/Parcelable$Creator;

    move-result-object v1

    invoke-static {p1, p3, v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readParcelableList(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, p3, v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readList(Landroid/os/Parcel;ILjava/lang/ClassLoader;)Ljava/util/ArrayList;
    ...
    :pswitch_e
    invoke-static {p1, p3}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readStringList(Landroid/os/Parcel;I)Ljava/util/ArrayList;
    ...
    invoke-static {p1, p3, v1}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->readParcelable(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
...
.method public static readObject(Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable;Landroid/os/Parcel;)V
    ...
    invoke-static {v5}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelUtil;->getFieldId(Ljava/lang/reflect/Field;)I
    ...
    invoke-static {v2}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->getFieldId(I)I
    ...
    const-string v4, "Unknown field id %d in %s, skipping."
    ...
    invoke-static {p1, v2}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelReader;->skip(Landroid/os/Parcel;I)V

    goto :goto_3

    :cond_4
    :try_start_0
    invoke-static {p0, p1, v4, v2}, Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelUtil;->readField(Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable;Landroid/os/Parcel;Ljava/lang/reflect/Field;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static writeField(Lcom/zeekr/sdk/mediacenter/bean/safeparcel/SafeParcelable;Landroid/os/Parcel;Ljava/lang/reflect/Field;I)V
    ...
    invoke-static {v3}, Lcom/zeekr/sdk/mediacenter/i;->a(I)I
