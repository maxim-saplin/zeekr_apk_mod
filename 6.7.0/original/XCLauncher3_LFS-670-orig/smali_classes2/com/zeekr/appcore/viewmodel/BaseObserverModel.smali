...
.method public final j(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-super {p0, p1, p2}, Lcom/zeekr/appcore/ext/BaseContentObserver;->j(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public abstract k(Landroid/database/Cursor;)Lcom/zeekr/appcore/mode/AppMetaData;
...
.method public final n(Ljava/lang/Integer;Ljava/lang/Integer;)Z
    .locals 10
...
.method public r(Ljava/util/ArrayList;)V
    ...
    invoke-static {v1}, Lkotlin/collections/CollectionsKt;->V(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {v0, v1}, Lkotlin/collections/SetsKt;->a(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v3}, Lcom/zeekr/appcore/ext/BaseContentObserver;->h(Ljava/lang/String;)V

    invoke-static {v1, v0}, Lkotlin/collections/SetsKt;->a(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v1}, Lcom/zeekr/appcore/ext/BaseContentObserver;->h(Ljava/lang/String;)V
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/zeekr/appcore/viewmodel/BaseObserverModel;->m()Ljava/util/List;
    ...
    invoke-direct {v1, v0, p1}, Lcom/zeekr/appcore/viewmodel/BaseObserverModel$sort$2;-><init>(Ljava/util/List;Ljava/util/ArrayList;)V
