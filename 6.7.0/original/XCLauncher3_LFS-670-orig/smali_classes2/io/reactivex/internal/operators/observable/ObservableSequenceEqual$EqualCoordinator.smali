...
.field public final c:[Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.method public constructor <init>(Lio/reactivex/Observer;)V
    ...
    new-array v0, p1, [Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;

    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->c:[Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;

    new-instance v1, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;-><init>(Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;I)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->b:Lio/reactivex/internal/disposables/ArrayCompositeDisposable;
...
.method public final a()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->c:[Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;
    ...
    :cond_1
    iget-boolean v7, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->d:Z
    ...
    iput-boolean v4, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->d:Z
    ...
    :cond_4
    iget-object v9, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->e:Ljava/lang/Object;
    ...
    iput-object v9, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->e:Ljava/lang/Object;
    ...
    :goto_0
    iget-object v10, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->f:Ljava/lang/Object;
    ...
    iput-object v10, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->f:Ljava/lang/Object;
...
.method public final d()Z
    ...
    iget-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->d:Z
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->d:Z

    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->b:Lio/reactivex/internal/disposables/ArrayCompositeDisposable;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->c:[Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualObserver;
