...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$ThreadWorker;-><init>(Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;)V
    ...
    invoke-direct {v0, v3, v4, v5, v2}, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;-><init>(JLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;)V
...
.method public constructor <init>()V
    ...
    sget-object v0, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler;->c:Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v2, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler;->h:Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;

    invoke-direct {v1, v2}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v1, p0, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler;->b:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v1, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;

    sget-object v3, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler;->f:Ljava/util/concurrent/TimeUnit;

    sget-wide v4, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler;->e:J

    invoke-direct {v1, v4, v5, v3, v0}, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;-><init>(JLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;)V

    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, v1, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;->c:Lio/reactivex/rxjava3/disposables/CompositeDisposable;

    invoke-virtual {v0}, Lio/reactivex/rxjava3/disposables/CompositeDisposable;->dispose()V

    iget-object v0, v1, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;->e:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_2
    iget-object v0, v1, Lio/reactivex/rxjava3/internal/schedulers/IoScheduler$CachedWorkerPool;->d:Ljava/util/concurrent/ScheduledExecutorService;
