...
# instance fields
.field public final a:Lcom/github/mikephil/charting/components/XAxis;
...
.method public constructor <init>(Lcom/github/mikephil/charting/utils/ViewPortHandler;Lcom/github/mikephil/charting/components/XAxis;Lcom/github/mikephil/charting/utils/Transformer;)V
    ...
    iput-object p3, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->c:[F

    new-instance p3, Landroid/graphics/RectF;

    invoke-direct {p3}, Landroid/graphics/RectF;-><init>()V

    iput-object p3, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->d:Landroid/graphics/RectF;

    new-array p1, p1, [F

    iput-object p1, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->e:[F

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->f:Landroid/graphics/RectF;

    const/4 p1, 0x4

    new-array p1, p1, [F

    iput-object p1, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->g:[F

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->h:Landroid/graphics/Path;

    iput-object p2, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->a:Lcom/github/mikephil/charting/components/XAxis;
...
.method public a()V
    ...
    iget v2, v1, Lcom/github/mikephil/charting/utils/FSize;->b:F

    iget-object v3, p0, Lcom/github/mikephil/charting/renderer/AxisRenderer;->mAxisLabelPaint:Landroid/graphics/Paint;

    const-string v4, "Q"

    invoke-static {v3, v4}, Lcom/github/mikephil/charting/utils/Utils;->a(Landroid/graphics/Paint;Ljava/lang/String;)I

    move-result v3

    int-to-float v3, v3

    invoke-static {v2, v3}, Lcom/github/mikephil/charting/utils/Utils;->f(FF)Lcom/github/mikephil/charting/utils/FSize;
    ...
    iput v2, v0, Lcom/github/mikephil/charting/components/XAxis;->D:I
...
.method public b(Landroid/graphics/Canvas;FFLandroid/graphics/Path;)V
    .locals 0
...
.method public final c(Landroid/graphics/Canvas;Ljava/lang/String;FFLcom/github/mikephil/charting/utils/MPPointF;)V
    .locals 8
...
.method public final computeAxisValues(FF)V
    ...
    invoke-virtual {p0}, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->a()V

    return-void
.end method

.method public d(Landroid/graphics/Canvas;FLcom/github/mikephil/charting/utils/MPPointF;)V
    .locals 11

    const/4 v6, 0x1

    iget-object v7, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->a:Lcom/github/mikephil/charting/components/XAxis;
    ...
    invoke-virtual {v1, v0}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->h(F)Z
    ...
    invoke-interface {v1, v2, v7}, Lcom/github/mikephil/charting/formatter/IAxisValueFormatter;->a(FLcom/github/mikephil/charting/components/AxisBase;)Ljava/lang/String;

    move-result-object v2

    iget-boolean v1, v7, Lcom/github/mikephil/charting/components/XAxis;->E:Z

    if-eqz v1, :cond_1

    iget v1, v7, Lcom/github/mikephil/charting/components/AxisBase;->l:I
    ...
    iget v4, v3, Lcom/github/mikephil/charting/utils/ViewPortHandler;->c:F
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->c(Landroid/graphics/Canvas;Ljava/lang/String;FFLcom/github/mikephil/charting/utils/MPPointF;)V
...
.method public renderAxisLabels(Landroid/graphics/Canvas;)V
    ...
    iget-object v4, v0, Lcom/github/mikephil/charting/components/XAxis;->F:Lcom/github/mikephil/charting/components/XAxis$XAxisPosition;
    ...
    invoke-virtual {p0, p1, v0, v3}, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->d(Landroid/graphics/Canvas;FLcom/github/mikephil/charting/utils/MPPointF;)V
    ...
    invoke-virtual {p0, p1, v2, v3}, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->d(Landroid/graphics/Canvas;FLcom/github/mikephil/charting/utils/MPPointF;)V
...
.method public final renderGridLines(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->c:[F
    ...
    iput-object v2, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->c:[F
    ...
    iget v5, v0, Lcom/github/mikephil/charting/components/AxisBase;->h:F

    invoke-virtual {v4, v5}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iget-object v4, p0, Lcom/github/mikephil/charting/renderer/AxisRenderer;->mGridPaint:Landroid/graphics/Paint;

    iget-object v0, v0, Lcom/github/mikephil/charting/components/AxisBase;->s:Landroid/graphics/DashPathEffect;

    invoke-virtual {v4, v0}, Landroid/graphics/Paint;->setPathEffect(Landroid/graphics/PathEffect;)Landroid/graphics/PathEffect;

    iget-object v0, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->b:Landroid/graphics/Path;
    ...
    invoke-virtual {p0, p1, v4, v5, v0}, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->b(Landroid/graphics/Canvas;FFLandroid/graphics/Path;)V
...
.method public renderLimitLines(Landroid/graphics/Canvas;)V
    ...
    iget-object v7, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->f:Landroid/graphics/RectF;
    ...
    iget-object v8, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->g:[F
    ...
    iget-object v7, p0, Lcom/github/mikephil/charting/renderer/XAxisRenderer;->h:Landroid/graphics/Path;
