...
.method static constructor <clinit>()V
    ...
    const-string v2, "MFLINE_BREAK_MODE_CHAR_WRAPPING"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    const-string v3, "MFLINE_BREAK_MODE_CLIPPING"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;->MFLINE_BREAK_MODE_CLIPPING:Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    new-instance v3, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    const-string v4, "MFLINE_BREAK_MODE_TRUNCATING_HEAD"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;->MFLINE_BREAK_MODE_TRUNCATING_HEAD:Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    new-instance v4, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    const-string v5, "MFLINE_BREAK_MODE_TRUNCATING_TAIL"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;->MFLINE_BREAK_MODE_TRUNCATING_TAIL:Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    new-instance v5, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    const-string v6, "MFLINE_BREAK_MODE_TRUNCATING_MIDDLE"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;->MFLINE_BREAK_MODE_TRUNCATING_MIDDLE:Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    filled-new-array/range {v0 .. v5}, [Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;

    move-result-object v0

    sput-object v0, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;->$VALUES:[Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFLineBreakMode;
