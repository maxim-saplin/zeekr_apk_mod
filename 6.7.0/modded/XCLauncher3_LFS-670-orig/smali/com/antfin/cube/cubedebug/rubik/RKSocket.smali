...
.method private connect(Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/antfin/cube/cubedebug/rubik/RKSocket$RKWebSocketListener;

    invoke-direct {v0, p0}, Lcom/antfin/cube/cubedebug/rubik/RKSocket$RKWebSocketListener;-><init>(Lcom/antfin/cube/cubedebug/rubik/RKSocket;)V

    iput-object v0, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->webSocketListener:Lcom/antfin/cube/cubedebug/rubik/RKSocket$RKWebSocketListener;
    ...
    new-instance v0, Lcom/antfin/cube/cubedebug/rubik/platform19/RKSocketPlateform19;

    invoke-direct {v0, p0}, Lcom/antfin/cube/cubedebug/rubik/platform19/RKSocketPlateform19;-><init>(Lcom/antfin/cube/cubedebug/rubik/RKSocket;)V

    iput-object v0, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->rkSocketPlateform19:Lcom/antfin/cube/cubedebug/rubik/platform19/RKSocketPlateform19;

    :cond_0
    iget-object v0, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->rkSocketPlateform19:Lcom/antfin/cube/cubedebug/rubik/platform19/RKSocketPlateform19;

    invoke-virtual {v0, p1}, Lcom/antfin/cube/cubedebug/rubik/platform19/RKSocketPlateform19;->connect(Ljava/lang/String;)V

    return-void

    :cond_1
    new-instance v0, Lcopy/okhttp3/logger/HttpLoggingInterceptor;

    new-instance v1, Lcom/antfin/cube/cubedebug/rubik/RKSocket$Logger;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/antfin/cube/cubedebug/rubik/RKSocket$Logger;-><init>(Lcom/antfin/cube/cubedebug/rubik/RKSocket$1;)V

    invoke-direct {v0, v1}, Lcopy/okhttp3/logger/HttpLoggingInterceptor;-><init>(Lcopy/okhttp3/logger/HttpLoggingInterceptor$Logger;)V

    sget-object v1, Lcopy/okhttp3/logger/HttpLoggingInterceptor$Level;->c:Lcopy/okhttp3/logger/HttpLoggingInterceptor$Level;

    iput-object v1, v0, Lcopy/okhttp3/logger/HttpLoggingInterceptor;->b:Lcopy/okhttp3/logger/HttpLoggingInterceptor$Level;

    new-instance v1, Lcopy/okhttp3/OkHttpClient$Builder;

    invoke-direct {v1}, Lcopy/okhttp3/OkHttpClient$Builder;-><init>()V
    ...
    iput v3, v1, Lcopy/okhttp3/OkHttpClient$Builder;->z:I

    iget-object v3, v1, Lcopy/okhttp3/OkHttpClient$Builder;->c:Ljava/util/ArrayList;

    invoke-virtual {v3, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v0, Lcopy/okhttp3/OkHttpClient;

    invoke-direct {v0, v1}, Lcopy/okhttp3/OkHttpClient;-><init>(Lcopy/okhttp3/OkHttpClient$Builder;)V

    iput-object v0, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->mClient:Lcopy/okhttp3/OkHttpClient;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/alibaba/fastjson/JSONObject;->Q(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v3, v1}, Lcom/alibaba/fastjson/JSONObject;->Q(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v1}, Lcopy/okhttp3/Request$Builder;-><init>()V

    invoke-virtual {v1, p1}, Lcopy/okhttp3/Request$Builder;->d(Ljava/lang/String;)V

    const-string/jumbo p1, "session"

    invoke-virtual {v1, p1, v0}, Lcopy/okhttp3/Request$Builder;->b(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v1}, Lcopy/okhttp3/Request$Builder;->a()Lcopy/okhttp3/Request;

    move-result-object p1

    iget-object v0, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->mClient:Lcopy/okhttp3/OkHttpClient;

    iget-object v6, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->webSocketListener:Lcom/antfin/cube/cubedebug/rubik/RKSocket$RKWebSocketListener;
    ...
    new-instance v1, Lcopy/okhttp3/internal/ws/RealWebSocket;

    sget-object v4, Lcopy/okhttp3/internal/concurrent/TaskRunner;->h:Lcopy/okhttp3/internal/concurrent/TaskRunner;

    new-instance v7, Ljava/util/Random;

    invoke-direct {v7}, Ljava/util/Random;-><init>()V

    iget v3, v0, Lcopy/okhttp3/OkHttpClient;->z:I

    int-to-long v8, v3

    iget-wide v10, v0, Lcopy/okhttp3/OkHttpClient;->A:J

    move-object v3, v1

    move-object v5, p1

    invoke-direct/range {v3 .. v11}, Lcopy/okhttp3/internal/ws/RealWebSocket;-><init>(Lcopy/okhttp3/internal/concurrent/TaskRunner;Lcopy/okhttp3/Request;Lcopy/okhttp3/WebSocketListener;Ljava/util/Random;JJ)V

    iget-object v3, p1, Lcopy/okhttp3/Request;->d:Lcopy/okhttp3/Headers;

    const-string v4, "Sec-WebSocket-Extensions"

    invoke-virtual {v3, v4}, Lcopy/okhttp3/Headers;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, v2}, Lcopy/okhttp3/internal/ws/RealWebSocket;->c(Ljava/lang/Exception;Lcopy/okhttp3/Response;)V

    goto/16 :goto_2

    :cond_2
    invoke-virtual {v0}, Lcopy/okhttp3/OkHttpClient;->a()Lcopy/okhttp3/OkHttpClient$Builder;
    ...
    new-instance v5, Lcopy/okhttp3/internal/Util$asFactory$1;

    invoke-direct {v5, v3}, Lcopy/okhttp3/internal/Util$asFactory$1;-><init>(Lcopy/okhttp3/EventListener$Companion$NONE$1;)V

    iput-object v5, v0, Lcopy/okhttp3/OkHttpClient$Builder;->e:Lcopy/okhttp3/internal/Util$asFactory$1;

    sget-object v3, Lcopy/okhttp3/internal/ws/RealWebSocket;->w:Ljava/util/List;
    ...
    sget-object v5, Lcopy/okhttp3/Protocol;->f:Lcopy/okhttp3/Protocol;
    ...
    :cond_6
    :goto_1
    sget-object v5, Lcopy/okhttp3/Protocol;->b:Lcopy/okhttp3/Protocol;
    ...
    sget-object v5, Lcopy/okhttp3/Protocol;->d:Lcopy/okhttp3/Protocol;

    invoke-virtual {v3, v5}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v5, v0, Lcopy/okhttp3/OkHttpClient$Builder;->s:Ljava/util/List;
    ...
    iput-object v2, v0, Lcopy/okhttp3/OkHttpClient$Builder;->B:Lcopy/okhttp3/internal/connection/RouteDatabase;
    ...
    iput-object v2, v0, Lcopy/okhttp3/OkHttpClient$Builder;->s:Ljava/util/List;

    new-instance v2, Lcopy/okhttp3/OkHttpClient;

    invoke-direct {v2, v0}, Lcopy/okhttp3/OkHttpClient;-><init>(Lcopy/okhttp3/OkHttpClient$Builder;)V

    invoke-virtual {p1}, Lcopy/okhttp3/Request;->a()Lcopy/okhttp3/Request$Builder;
    ...
    invoke-virtual {p1, v0, v3}, Lcopy/okhttp3/Request$Builder;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v3, "Connection"

    invoke-virtual {p1, v3, v0}, Lcopy/okhttp3/Request$Builder;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "Sec-WebSocket-Key"

    iget-object v3, v1, Lcopy/okhttp3/internal/ws/RealWebSocket;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1, v4, v0}, Lcopy/okhttp3/Request$Builder;->b(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Lcopy/okhttp3/Request$Builder;->a()Lcopy/okhttp3/Request;

    move-result-object p1

    new-instance v0, Lcopy/okhttp3/internal/connection/RealCall;

    invoke-direct {v0, v2, p1, v6}, Lcopy/okhttp3/internal/connection/RealCall;-><init>(Lcopy/okhttp3/OkHttpClient;Lcopy/okhttp3/Request;Z)V

    iput-object v0, v1, Lcopy/okhttp3/internal/ws/RealWebSocket;->b:Lcopy/okhttp3/internal/connection/RealCall;

    new-instance v2, Lcopy/okhttp3/internal/ws/RealWebSocket$connect$1;

    invoke-direct {v2, v1, p1}, Lcopy/okhttp3/internal/ws/RealWebSocket$connect$1;-><init>(Lcopy/okhttp3/internal/ws/RealWebSocket;Lcopy/okhttp3/Request;)V

    invoke-virtual {v0, v2}, Lcopy/okhttp3/internal/connection/RealCall;->d(Lcopy/okhttp3/Callback;)V

    :goto_2
    iput-object v1, p0, Lcom/antfin/cube/cubedebug/rubik/RKSocket;->websocket:Lcopy/okhttp3/WebSocket;
