...
.method private static getFileBufferFromNet(Ljava/lang/String;ZLcom/antfin/cube/cubedebug/rubik/RKResourceLoader$GetFileBufferCallback;)[B
    ...
    :cond_3
    invoke-virtual {v3}, Lcopy/okhttp3/ResponseBody;->c()[B
...
.method private static getUrlResponse(Ljava/lang/String;Z)Lcopy/okhttp3/Response;
    ...
    iput-boolean v3, p1, Lcopy/okhttp3/CacheControl$Builder;->c:Z
    ...
    iget-object p1, v2, Lcopy/okhttp3/Request$Builder;->c:Lcopy/okhttp3/Headers$Builder;

    invoke-virtual {p1, v4}, Lcopy/okhttp3/Headers$Builder;->f(Ljava/lang/String;)V

    goto :goto_1

    :cond_2
    invoke-virtual {v2, v4, p1}, Lcopy/okhttp3/Request$Builder;->b(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    const-string p1, "GET"

    invoke-virtual {v2, p1, v1}, Lcopy/okhttp3/Request$Builder;->c(Ljava/lang/String;Lcopy/okhttp3/RequestBody;)V
    ...
    invoke-virtual {v2, p0}, Lcopy/okhttp3/Request$Builder;->d(Ljava/lang/String;)V
...
.method public static uploadFile(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, v1}, Lcopy/okhttp3/Request$Builder;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcopy/okhttp3/Request$Builder;->c(Ljava/lang/String;Lcopy/okhttp3/RequestBody;)V
