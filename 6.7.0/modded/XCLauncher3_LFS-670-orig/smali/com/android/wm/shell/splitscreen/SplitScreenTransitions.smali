...
.method public constructor <init>(Lcom/android/wm/shell/common/TransactionPool;Lcom/android/wm/shell/transition/Transitions;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/wm/shell/splitscreen/y;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;)V
...
.method public static synthetic c(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic d(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/window/WindowContainerTransaction;Landroid/window/WindowContainerTransactionCallback;)V
    .locals 0
...
.method public static synthetic e(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic f(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method private synthetic lambda$startExampleAnimation$3(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FLandroid/animation/ValueAnimator;)V
    ...
    new-instance p2, Lcom/android/wm/shell/splitscreen/v;

    const/4 p3, 0x0

    invoke-direct {p2, p0, p4, p3}, Lcom/android/wm/shell/splitscreen/v;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/animation/ValueAnimator;I)V
...
.method private playInternalAnimation(Landroid/os/IBinder;Landroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/window/WindowContainerToken;Landroid/window/WindowContainerToken;)V
    ...
    invoke-static {p3, v7}, Lcom/android/wm/shell/h;->p(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V

    invoke-virtual {p2}, Landroid/window/TransitionInfo;->getRootLeash()Landroid/view/SurfaceControl;

    move-result-object v7

    invoke-static {p3, v3, v7}, Lcom/android/wm/shell/h;->s(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)V
    ...
    invoke-static {p3, v3, v7}, Lcom/android/wm/shell/h;->r(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;I)V
    ...
    invoke-static {v7, v3, v5}, Lcom/android/wm/shell/h;->s(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)V
    ...
    invoke-static {v5, v3, v7, v8}, La/a;->q(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)V
    ...
    invoke-static {p3, v3}, Lcom/android/wm/shell/common/split/c;->A(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    :cond_b
    invoke-static {p3}, Landroidx/transition/a;->u(Landroid/view/SurfaceControl$Transaction;)V
...
.method private startExampleAnimation(Landroid/view/SurfaceControl;Z)V
    ...
    new-instance v2, Lcom/android/wm/shell/splitscreen/w;

    invoke-direct {v2, v4, p1, v1, v6}, Lcom/android/wm/shell/splitscreen/w;-><init>(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/wm/shell/splitscreen/x;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FLandroid/animation/ValueAnimator;)V

    new-instance p1, Lcom/android/wm/shell/splitscreen/SplitScreenTransitions$1;

    invoke-direct {p1, p0, v1}, Lcom/android/wm/shell/splitscreen/SplitScreenTransitions$1;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Ljava/lang/Runnable;)V
...
.method private startExampleResizeAnimation(Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v1, v3, p1, p2, p3}, Lcom/android/wm/shell/splitscreen/t;-><init>(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    invoke-virtual {v7, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance p2, Lcom/android/wm/shell/splitscreen/u;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/wm/shell/splitscreen/u;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/animation/ValueAnimator;)V
