...
.method public constructor <init>(Landroid/content/Context;Landroid/view/SurfaceSession;Lcom/android/wm/shell/common/TransactionPool;Landroid/view/SurfaceControl$Transaction;Landroid/window/TransitionInfo$Change;Landroid/view/SurfaceControl;)V
    ...
    iput-object v3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mTmpFloats:[F

    new-instance v3, Landroid/graphics/Matrix;

    invoke-direct {v3}, Landroid/graphics/Matrix;-><init>()V

    iput-object v3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    iput-object v3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mStartBounds:Landroid/graphics/Rect;

    new-instance v4, Landroid/graphics/Rect;

    invoke-direct {v4}, Landroid/graphics/Rect;-><init>()V

    iput-object v4, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mEndBounds:Landroid/graphics/Rect;
    ...
    iput v5, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mStartHeight:I
    ...
    iput v6, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mEndWidth:I
    ...
    iput v6, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mEndHeight:I

    invoke-virtual {p5}, Landroid/window/TransitionInfo$Change;->getStartRotation()I

    move-result v6

    iput v6, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mStartRotation:I

    invoke-virtual {p5}, Landroid/window/TransitionInfo$Change;->getEndRotation()I

    move-result v6

    iput v6, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mEndRotation:I
    ...
    invoke-static {p5, p6}, Lcom/android/wm/shell/h;->g(Landroid/view/SurfaceControl$Builder;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Builder;
    ...
    const-string v3, "ShellRotationAnimation"

    invoke-virtual {p5, v3}, Landroid/view/SurfaceControl$Builder;->setCallsite(Ljava/lang/String;)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-static {p5}, Lcom/android/wm/shell/h;->l(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl;
    ...
    invoke-virtual {p5, v1}, Landroid/view/SurfaceControl$LayerCaptureArgs$Builder;->setCaptureSecureLayers(Z)Landroid/view/SurfaceControl$CaptureArgs$Builder;

    move-result-object p1

    check-cast p1, Landroid/view/SurfaceControl$LayerCaptureArgs$Builder;

    invoke-virtual {p1, v1}, Landroid/view/SurfaceControl$LayerCaptureArgs$Builder;->setAllowProtected(Z)Landroid/view/SurfaceControl$CaptureArgs$Builder;
    ...
    invoke-direct {p5, v0, v0, p3, v5}, Landroid/graphics/Rect;-><init>(IIII)V

    invoke-virtual {p1, p5}, Landroid/view/SurfaceControl$LayerCaptureArgs$Builder;->setSourceCrop(Landroid/graphics/Rect;)Landroid/view/SurfaceControl$CaptureArgs$Builder;
    ...
    invoke-static {p3, p6}, Lcom/android/wm/shell/h;->g(Landroid/view/SurfaceControl$Builder;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-virtual {p3, v3}, Landroid/view/SurfaceControl$Builder;->setCallsite(Ljava/lang/String;)Landroid/view/SurfaceControl$Builder;

    move-result-object p3

    invoke-static {p3}, Lcom/android/wm/shell/transition/j;->d(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl$Builder;

    move-result-object p3

    invoke-static {p3}, Lcom/android/wm/shell/h;->l(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl;

    move-result-object p3

    iput-object p3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mBackColorSurface:Landroid/view/SurfaceControl;
    ...
    invoke-static {p3, p2}, Lcom/android/wm/shell/h;->g(Landroid/view/SurfaceControl$Builder;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-virtual {p2, p3}, Landroid/view/SurfaceControl$Builder;->setSecure(Z)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-static {p2}, Lcom/android/wm/shell/h;->l(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl;
    ...
    iget-object p3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mBackColorSurface:Landroid/view/SurfaceControl;

    invoke-static {p4, p3}, Lcom/android/wm/shell/transition/j;->e(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    invoke-virtual {p4, p3, p6}, Landroid/view/SurfaceControl$Transaction;->setColor(Landroid/view/SurfaceControl;[F)Landroid/view/SurfaceControl$Transaction;

    iget-object p3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mBackColorSurface:Landroid/view/SurfaceControl;

    invoke-static {p4, p3}, Lcom/android/wm/shell/h;->p(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    iget-object p3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mAnimLeash:Landroid/view/SurfaceControl;

    invoke-static {p4, p3}, Lcom/android/wm/shell/transition/j;->c(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V

    iget-object p3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mAnimLeash:Landroid/view/SurfaceControl;

    invoke-static {p4, p3}, La/a;->o(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    iget-object p3, p0, Lcom/android/wm/shell/transition/ScreenRotationAnimation;->mScreenshotLayer:Landroid/view/SurfaceControl;

    invoke-virtual {p4, p3, p2}, Landroid/view/SurfaceControl$Transaction;->setBuffer(Landroid/view/SurfaceControl;Landroid/graphics/GraphicBuffer;)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-virtual {p4, p2, p1}, Landroid/view/SurfaceControl$Transaction;->setColorSpace(Landroid/view/SurfaceControl;Landroid/graphics/ColorSpace;)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-static {v2, p2, p1}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static {p4}, Landroidx/transition/a;->u(Landroid/view/SurfaceControl$Transaction;)V
...
.method private static applyColor(II[FFLandroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;)V
    ...
    :cond_0
    invoke-static {p5}, Landroidx/transition/a;->u(Landroid/view/SurfaceControl$Transaction;)V
...
.method private setRotationTransform(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;)V
    ...
    invoke-static {p1, v1, v0, p2}, La/a;->q(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)V
    ...
    invoke-static {p1, p2}, Lcom/android/wm/shell/h;->p(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
...
.method private startColorAnimation(FLcom/android/wm/shell/common/ShellExecutor;)V
    ...
    new-instance v0, Lcom/android/wm/shell/transition/k;
    ...
    new-instance v0, Lcom/android/wm/shell/transition/ScreenRotationAnimation$1;
    ...
    new-instance p1, Lcom/android/wm/shell/legacysplitscreen/g;

    invoke-direct {p1, v12, v11}, Lcom/android/wm/shell/legacysplitscreen/g;-><init>(Ljava/lang/Object;I)V
...
.method public kill()V
    ...
    :cond_4
    invoke-static {v0}, Landroidx/transition/a;->u(Landroid/view/SurfaceControl$Transaction;)V
