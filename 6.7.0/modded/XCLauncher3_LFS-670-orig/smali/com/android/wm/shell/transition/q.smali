...
.method public final run()V
    ...
    iget-object v0, p0, Lcom/android/wm/shell/transition/q;->c:Landroid/window/TransitionInfo;

    iget-object v1, p0, Lcom/android/wm/shell/transition/q;->d:Landroid/view/SurfaceControl$Transaction;

    iget-object v2, p0, Lcom/android/wm/shell/transition/q;->e:Landroid/view/SurfaceControl$Transaction;

    iget-object v3, p0, Lcom/android/wm/shell/transition/q;->a:Lcom/android/wm/shell/transition/Transitions$TransitionPlayerImpl;

    iget-object v4, p0, Lcom/android/wm/shell/transition/q;->b:Landroid/os/IBinder;

    invoke-static {v3, v4, v0, v1, v2}, Lcom/android/wm/shell/transition/Transitions$TransitionPlayerImpl;->b(Lcom/android/wm/shell/transition/Transitions$TransitionPlayerImpl;Landroid/os/IBinder;Landroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl$Transaction;)V
