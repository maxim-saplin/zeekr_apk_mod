...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/pip/phone/PhonePipMenuController;Lcom/android/wm/shell/pip/PipBoundsAlgorithm;Lcom/android/wm/shell/pip/PipBoundsState;Lcom/android/wm/shell/pip/PipTaskOrganizer;Lcom/android/wm/shell/pip/phone/PipMotionHelper;Lcom/android/wm/shell/common/FloatingContentCoordinator;Lcom/android/wm/shell/pip/PipUiEventLogger;Lcom/android/wm/shell/common/ShellExecutor;)V
    ...
    new-instance v6, Lcom/android/wm/shell/pip/phone/o0;

    invoke-direct {v6, v0}, Lcom/android/wm/shell/pip/phone/o0;-><init>(Lcom/android/wm/shell/pip/phone/PipTouchHandler;)V

    new-instance v4, Lcom/android/wm/shell/pip/phone/p0;

    const/4 v1, 0x0

    invoke-direct {v4, v0, v1}, Lcom/android/wm/shell/pip/phone/p0;-><init>(Lcom/android/wm/shell/pip/phone/PipTouchHandler;I)V
    ...
    invoke-direct {v3, v0, v4}, Lcom/android/wm/shell/pip/phone/p0;-><init>(Lcom/android/wm/shell/pip/phone/PipTouchHandler;I)V
    ...
    invoke-direct {v9, v0, v1}, Lcom/android/wm/shell/pip/phone/p0;-><init>(Lcom/android/wm/shell/pip/phone/PipTouchHandler;I)V
...
.method public static synthetic b(Lcom/android/wm/shell/pip/phone/PipTouchHandler;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    .locals 0
...
.method public static synthetic e(Lcom/android/wm/shell/pip/phone/PipTouchHandler;)V
    .locals 0
...
.method public onMovementBoundsChanged(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZI)V
    ...
    invoke-virtual {v3, p2, p1, v2, v0}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {v3, p3, p1, v4, v1}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    iget-object v5, p0, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->mContext:Landroid/content/Context;

    invoke-static {v5}, Landroidx/core/view/g;->h(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v5

    invoke-virtual {v5, v4}, Landroid/view/Display;->getRealSize(Landroid/graphics/Point;)V

    iget-object v5, p0, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->mPipBoundsAlgorithm:Lcom/android/wm/shell/pip/PipBoundsAlgorithm;

    iget v6, p0, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->mExpandedShortestEdgeSize:I
    ...
    invoke-virtual {v5, v3, v6, v7, v4}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getSizeForAspectRatio(FFII)Landroid/util/Size;
    ...
    invoke-virtual {v5, v6}, Lcom/android/wm/shell/pip/PipBoundsState;->setExpandedBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v5, v6, p1, v4, v0}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    invoke-direct {p0, p1, p2, v3}, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->updatePinchResizeSizeConstraints(Landroid/graphics/Rect;Landroid/graphics/Rect;F)V
    ...
    invoke-virtual {v0, v3, v5}, Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;->updateMinSize(II)V
    ...
    invoke-virtual {v5}, Lcom/android/wm/shell/pip/PipBoundsState;->getExpandedBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v3, v5}, Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;->updateMaxSize(II)V
    ...
    iget v3, p0, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->mImeOffset:I
    ...
    :cond_a
    invoke-virtual {v3, p3, p1, p4, v1}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    iget v3, p0, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->mMovementBoundsExtraOffsets:I
    ...
    invoke-virtual {p5}, Lcom/android/wm/shell/pip/PipBoundsState;->getExpandedBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual {p5}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getSnapAlgorithm()Lcom/android/wm/shell/pip/PipSnapAlgorithm;

    move-result-object p5

    iget v5, p0, Lcom/android/wm/shell/pip/phone/PipTouchHandler;->mSavedSnapFraction:F

    invoke-virtual {p5, p3, p4, v5}, Lcom/android/wm/shell/pip/PipSnapAlgorithm;->applySnapFraction(Landroid/graphics/Rect;Landroid/graphics/Rect;F)V
    ...
    invoke-virtual {p5, p3, v3}, Lcom/android/wm/shell/pip/phone/PipMotionHelper;->animateToOffset(Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {p3, v4}, Lcom/android/wm/shell/pip/PipBoundsState;->setExpandedMovementBounds(Landroid/graphics/Rect;)V
