...
.method private synthetic lambda$onDisplayChanged$5(Lcom/android/wm/shell/common/DisplayLayout;)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Lcom/android/wm/shell/pip/PipTaskOrganizer;->applyFinishBoundsResize(Landroid/window/WindowContainerTransaction;IZ)V
...
.method private onDisplayChanged(Lcom/android/wm/shell/common/DisplayLayout;Z)V
    ...
    invoke-virtual {v1, p2}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, p2, v1, v2}, Lcom/android/wm/shell/pip/PipSnapAlgorithm;->getSnapFraction(Landroid/graphics/Rect;Landroid/graphics/Rect;I)F

    move-result v3

    invoke-static {p0, p1}, Lcom/android/wm/shell/pip/phone/PipController;->a(Lcom/android/wm/shell/pip/phone/PipController;Lcom/android/wm/shell/common/DisplayLayout;)V

    iget-object p1, p0, Lcom/android/wm/shell/pip/phone/PipController;->mPipBoundsAlgorithm:Lcom/android/wm/shell/pip/PipBoundsAlgorithm;

    const/4 v1, 0x0

    invoke-virtual {p1, p2, v1}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;Z)Landroid/graphics/Rect;
...
.method private onOverlayChanged()V
    ...
    invoke-static {v1}, Landroidx/core/view/g;->h(Landroid/content/Context;)Landroid/view/Display;
...
.method public init()V
    ...
    new-instance v4, Lcom/android/wm/shell/pip/phone/m;

    invoke-direct {v4, v2}, Lcom/android/wm/shell/pip/phone/m;-><init>(Lcom/android/wm/shell/pip/phone/PipTouchHandler;)V
    ...
    invoke-direct {v4, v3}, Lcom/android/wm/shell/pip/phone/m;-><init>(Lcom/android/wm/shell/pip/phone/PipTouchHandler;)V
    ...
    invoke-static {v4}, Landroidx/core/view/g;->h(Landroid/content/Context;)Landroid/view/Display;
