...
# virtual methods
.method public final M(Lokio/ByteString;)Lokio/BufferedSink;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lokio/Buffer;->a0(Lokio/ByteString;)V
...
.method public final b(Ljava/lang/String;)Lokio/BufferedSink;
    .locals 1
...
.method public final c()Lokio/BufferedSink;
    ...
    invoke-interface {v3, v0, v1, v2}, Lokio/Sink;->u(Lokio/Buffer;J)V
...
.method public final close()V
    ...
    invoke-interface {v0, v1, v2, v3}, Lokio/Sink;->u(Lokio/Buffer;J)V
    :try_end_0
...
.method public final d(J)Lokio/BufferedSink;
    ...
    invoke-virtual {v0, p1, p2}, Lokio/Buffer;->e0(J)V
...
.method public final flush()V
    ...
    invoke-interface {v4, v0, v1, v2}, Lokio/Sink;->u(Lokio/Buffer;J)V
...
.method public final i(I[B)Lokio/BufferedSink;
    .locals 2
    .param p2    # [B
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p2, v1, p1}, Lokio/Buffer;->c0([BII)V
...
.method public final u(Lokio/Buffer;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lokio/Buffer;->u(Lokio/Buffer;J)V
...
.method public final v(Lokio/Source;)J
    ...
    invoke-interface {p1, v2, v3, v4}, Lokio/Source;->N(Lokio/Buffer;J)J
...
.method public final z([B)Lokio/BufferedSink;
    .locals 1
    .param p1    # [B
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lokio/Buffer;->b0([B)V
