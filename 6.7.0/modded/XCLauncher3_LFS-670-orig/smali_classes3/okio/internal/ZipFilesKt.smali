...
.method public static final a(Ljava/util/ArrayList;)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {v1, v0}, Lokio/internal/ZipEntry;-><init>(Lokio/Path;)V
    ...
    invoke-static {v0}, Lkotlin/collections/MapsKt;->h([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/CollectionsKt;->N(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/util/List;
...
.method public static final c(Lokio/RealBufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-virtual/range {p0 .. p0}, Lokio/RealBufferedSource;->r()I
    ...
    invoke-virtual/range {p0 .. p0}, Lokio/RealBufferedSource;->x()S
    ...
    invoke-virtual {v8, v0, v1}, Lokio/RealBufferedSource;->y(J)Ljava/lang/String;

    move-result-object v6

    invoke-static {v6, v9}, Lkotlin/text/StringsKt;->n(Ljava/lang/CharSequence;C)Z
    ...
    invoke-static {v2, v0, v1}, Lkotlin/text/StringsKt;->o(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iget-wide v8, v1, Lkotlin/jvm/internal/Ref$LongRef;->a:J
...
.method public static final d(Lokio/RealBufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-virtual {p0}, Lokio/RealBufferedSource;->x()S
    ...
    invoke-virtual {p0, v4, v5}, Lokio/RealBufferedSource;->B(J)V
...
.method public static final e(Lokio/RealBufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-virtual {p0}, Lokio/RealBufferedSource;->r()I
    ...
    invoke-static {v6}, Lokio/internal/ZipFilesKt;->b(I)Ljava/lang/String;
