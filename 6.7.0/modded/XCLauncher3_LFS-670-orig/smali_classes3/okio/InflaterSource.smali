...
.method public final N(Lokio/Buffer;J)J
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Lokio/InflaterSource;->c(Lokio/Buffer;J)J
    ...
    invoke-virtual {v0}, Lokio/RealBufferedSource;->E()Z
...
.method public final c(Lokio/Buffer;J)J
    .locals 7
    .param p1    # Lokio/Buffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :try_start_0
    invoke-virtual {p1, v3}, Lokio/Buffer;->Z(I)Lokio/Segment;
