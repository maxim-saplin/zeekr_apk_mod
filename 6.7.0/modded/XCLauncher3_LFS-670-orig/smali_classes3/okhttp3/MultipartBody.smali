...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lokhttp3/MultipartBody$Companion;

    invoke-direct {v1}, Lokhttp3/MultipartBody$Companion;-><init>()V

    sput-object v1, Lokhttp3/MultipartBody;->Companion:Lokhttp3/MultipartBody$Companion;
...
.method public final f(Lokio/BufferedSink;Z)J
    ...
    invoke-interface {v1, v10}, Lokio/BufferedSink;->z([B)Lokio/BufferedSink;

    invoke-interface {v1, v9}, Lokio/BufferedSink;->M(Lokio/ByteString;)Lokio/BufferedSink;

    invoke-interface {v1, v11}, Lokio/BufferedSink;->z([B)Lokio/BufferedSink;
    ...
    invoke-interface {v1, v14}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v14

    sget-object v15, Lokhttp3/MultipartBody;->g:[B

    invoke-interface {v14, v15}, Lokio/BufferedSink;->z([B)Lokio/BufferedSink;
    ...
    invoke-interface {v14, v15}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v14

    invoke-interface {v14, v11}, Lokio/BufferedSink;->z([B)Lokio/BufferedSink;
    ...
    invoke-interface {v1, v12}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v12

    iget-object v10, v10, Lokhttp3/MediaType;->a:Ljava/lang/String;

    invoke-interface {v12, v10}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v10

    invoke-interface {v10, v11}, Lokio/BufferedSink;->z([B)Lokio/BufferedSink;
    ...
    invoke-interface {v1, v10}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v10

    invoke-interface {v10, v12, v13}, Lokio/BufferedSink;->d(J)Lokio/BufferedSink;
    ...
    invoke-virtual {v2}, Lokio/Buffer;->c()V
