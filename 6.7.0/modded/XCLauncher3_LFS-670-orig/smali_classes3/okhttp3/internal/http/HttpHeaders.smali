...
.method public static final b(Lokio/Buffer;Ljava/util/ArrayList;)V
    ...
    invoke-static {v6, v7}, Lkotlin/text/StringsKt;->D(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v9}, Lokio/Buffer;->r(J)B
    ...
    invoke-virtual {v0, v9}, Lokio/Buffer;->y(Lokio/ByteString;)J
    ...
    :cond_8
    invoke-virtual {v0, v9, v10}, Lokio/Buffer;->r(J)B

    move-result v11

    if-ne v11, v8, :cond_9

    invoke-virtual {v6, v0, v9, v10}, Lokio/Buffer;->u(Lokio/Buffer;J)V

    invoke-virtual/range {p0 .. p0}, Lokio/Buffer;->B()B

    invoke-virtual {v6}, Lokio/Buffer;->W()Ljava/lang/String;
    ...
    invoke-virtual {v6, v0, v13, v14}, Lokio/Buffer;->u(Lokio/Buffer;J)V
...
.method public static final c(Lokio/Buffer;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lokio/Buffer;->y(Lokio/ByteString;)J
...
.method public static final d(Lokhttp3/CookieJar;Lokhttp3/HttpUrl;Lokhttp3/Headers;)V
    ...
    invoke-virtual {v0, v3}, Lokhttp3/Headers;->f(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v9, v12, v5, v5, v13}, Lokhttp3/internal/Util;->g(Ljava/lang/String;CIII)I
    ...
    invoke-static {v9, v15, v5, v0, v14}, Lokhttp3/internal/Util;->g(Ljava/lang/String;CIII)I
    ...
    :cond_1
    invoke-static {v5, v14, v9}, Lokhttp3/internal/Util;->A(IILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v12, v9}, Lokhttp3/internal/Util;->A(IILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v12, v13, v9}, Lokhttp3/internal/Util;->A(IILjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lokhttp3/internal/Util;->g:Lkotlin/text/Regex;
...
.method public static final e(Lokio/Buffer;)Z
    ...
    :goto_0
    invoke-virtual {p0}, Lokio/Buffer;->E()Z
    ...
    invoke-virtual {p0, v1, v2}, Lokio/Buffer;->r(J)B
