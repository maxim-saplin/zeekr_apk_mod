...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/RealBufferedSource;Lokio/RealBufferedSink;)V
    ...
    .param p3    # Lokio/RealBufferedSource;
        ...
        .end annotation
    .end param
    .param p4    # Lokio/RealBufferedSink;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public static final i(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokio/ForwardingTimeout;)V
    .locals 2
...
.method public final c(Z)Lokhttp3/Response$Builder;
    ...
    iget-object v2, v0, Lokhttp3/internal/http1/HeadersReader;->a:Lokio/RealBufferedSource;

    iget-wide v4, v0, Lokhttp3/internal/http1/HeadersReader;->b:J

    invoke-virtual {v2, v4, v5}, Lokio/RealBufferedSource;->A(J)Ljava/lang/String;
    ...
    invoke-virtual {v5, v6, v7}, Lokio/RealBufferedSource;->A(J)Ljava/lang/String;
...
.method public final e(Lokhttp3/Response;)Lokio/Source;
    ...
    invoke-virtual {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->j(J)Lokio/Source;
    ...
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1ExchangeCodec;->j(J)Lokio/Source;
...
.method public final l(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lokio/RealBufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;
