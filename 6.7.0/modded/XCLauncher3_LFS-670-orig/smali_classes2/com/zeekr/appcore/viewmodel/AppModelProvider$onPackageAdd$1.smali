...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p1, Lcom/zeekr/appcore/mode/AppMetaData;->j:Lcom/zeekrlife/market/update/AppTaskInfo;
    ...
    invoke-virtual {v1, p1}, Lcom/zeekr/appcore/viewmodel/DualAudioModel;->b(Lcom/zeekr/appcore/mode/AppMetaData;)Z

    move-result v1

    iput-boolean v1, p1, Lcom/zeekr/appcore/mode/AppMetaData;->k:Z
    ...
    new-instance v5, Lcom/zeekr/appcore/viewmodel/AppsRepo$onPackageAdd$1;

    invoke-direct {v5, v1, v4, v2, v0}, Lcom/zeekr/appcore/viewmodel/AppsRepo$onPackageAdd$1;-><init>(Lcom/zeekr/appcore/viewmodel/AppsRepo;Ljava/util/ArrayList;ILkotlin/coroutines/Continuation;)V

    invoke-static {p1, v0, v0, v5, v3}, Lkotlinx/coroutines/BuildersKt;->c(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/Job;
    ...
    iget-object v6, v6, Lcom/zeekr/appcore/mode/AppMetaData;->j:Lcom/zeekrlife/market/update/AppTaskInfo;

    if-eqz v6, :cond_1

    invoke-virtual {v6}, Lcom/zeekrlife/market/update/AppTaskInfo;->getPackageName()Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lcom/zeekr/appcore/viewmodel/AppsRepo;->i(Ljava/util/List;)V

    invoke-static {v1}, Landroidx/lifecycle/ViewModelKt;->getViewModelScope(Landroidx/lifecycle/ViewModel;)Lkotlinx/coroutines/CoroutineScope;

    move-result-object p1

    new-instance v5, Lcom/zeekr/appcore/viewmodel/AppsRepo$onPackageAdd$2;

    invoke-direct {v5, v1, v4, v2, v0}, Lcom/zeekr/appcore/viewmodel/AppsRepo$onPackageAdd$2;-><init>(Lcom/zeekr/appcore/viewmodel/AppsRepo;Ljava/util/ArrayList;ILkotlin/coroutines/Continuation;)V
