...
.method public static final a(Lretrofit2/HttpException;)Lcom/zeekr/zhttp/network/exception/HttpResponseException;
    ...
    iget-object v1, v1, Lretrofit2/Response;->c:Lokhttp3/ResponseBody$Companion$asResponseBody$1;
    ...
    invoke-static {v1, v4, v5, v3}, Landroid/car/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final b(Lokhttp3/ResponseBody;)Lcom/zeekr/zhttp/network/bo/HttpResponse;
    ...
    invoke-virtual {p0, v1}, Lokio/Buffer;->v(Lokio/Source;)J

    invoke-virtual {p0}, Lokio/Buffer;->W()Ljava/lang/String;
