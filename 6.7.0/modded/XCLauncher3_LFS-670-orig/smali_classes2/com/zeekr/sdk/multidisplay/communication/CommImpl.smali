...
# virtual methods
.method public final getFrontDHUDevices()I
    .locals 8
...
.method public final getRearDHUDevices()I
    .locals 8
...
.method public final registerCommCallback(Ljava/lang/String;ILcom/zeekr/sdk/multidisplay/contract/ICommDataCallback;)V
    ...
    const-string v4, " registerCommCallback failed--->domain="

    const-string v5, "registerCommCallback success--->domain="
...
.method public final registerFileReceiveCallback(Ljava/lang/String;Ljava/lang/String;Lcom/zeekr/sdk/multidisplay/contract/IFileReceiveCallback;)V
    .locals 8

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v1, "registerFileReceiveCallback:"
    ...
    const-string v5, "registerFileReceiveCallback"
    ...
    iget-object p3, p3, Lcom/zeekr/sdk/multidisplay/contract/IBaseCallback;->callback:Lcom/zeekr/sdk/base/internal/IZeekrPlatformCallback;
    ...
    invoke-static {v1, p2, p1}, Lcom/zeekr/sdk/multidisplay/utils/Utils;->b(Ljava/lang/String;Lcom/zeekr/sdk/base/msg/ZeekrPlatformRetMessage;Ljava/lang/String;)V
    :try_end_0
    ...
    const-string p3, "registerFileReceiveCallback:IOException:"
    ...
    invoke-static {v1, p2}, Lcom/zeekr/sdk/multidisplay/utils/MDLogUtil;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final sendFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 8
    ...
    :try_start_0
    new-instance v0, Lcom/zeekr/sdk/multidisplay/bean/SendFileParam;

    invoke-direct {v0, p1, p2, p3}, Lcom/zeekr/sdk/multidisplay/bean/SendFileParam;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p3}, Lcom/zeekr/sdk/multidisplay/impl/MultidisplayImpl;->getServiceAlias()Ljava/lang/String;
    ...
    invoke-virtual {p1, p2}, Lcom/zeekr/sdk/base/impl/ZeekrPlatformApiClient;->call(Lcom/zeekr/sdk/base/msg/ZeekrPlatformMessage;)Lcom/zeekr/sdk/base/msg/ZeekrPlatformRetMessage;

    move-result-object p1

    iget-object p2, p2, Lcom/zeekr/sdk/base/msg/ZeekrPlatformMessage;->mMethod:Ljava/lang/String;

    invoke-static {v1, p1, p2}, Lcom/zeekr/sdk/multidisplay/utils/Utils;->b(Ljava/lang/String;Lcom/zeekr/sdk/base/msg/ZeekrPlatformRetMessage;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p3, "sendFile:IOException:"
...
.method public final startActivityOrService(Ljava/lang/String;Landroid/content/Intent;I)V
    .locals 2

    const-string v0, "startActivityOrService:screenName:"
    ...
    invoke-static {p2}, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceBean;->getIntentString(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_0
    new-instance v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceBean;

    invoke-direct {v0}, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceBean;-><init>()V

    iput-object p2, v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceBean;->intent:Landroid/content/Intent;

    iput p3, v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceBean;->type:I

    new-instance p2, Lcom/zeekr/sdk/multidisplay/bean/CommBean;

    invoke-direct {p2}, Lcom/zeekr/sdk/multidisplay/bean/CommBean;-><init>()V

    const-string p3, "MultiDisplayService"

    iput-object p3, p2, Lcom/zeekr/sdk/multidisplay/bean/CommBean;->domainName:Ljava/lang/String;

    const-string p3, "startActivityOrService"

    iput-object p3, p2, Lcom/zeekr/sdk/multidisplay/bean/CommBean;->dataId:Ljava/lang/String;

    :try_start_0
    const-class p3, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceBean;

    invoke-static {p3}, Lcom/zeekr/sdk/base/proto/ProtobufProxy;->create(Ljava/lang/Class;)Lcom/zeekr/sdk/base/proto/Codec;

    move-result-object p3

    invoke-interface {p3, v0}, Lcom/zeekr/sdk/base/proto/Codec;->encode(Ljava/lang/Object;)[B

    move-result-object p3

    iput-object p3, p2, Lcom/zeekr/sdk/multidisplay/bean/CommBean;->data:[B

    iget-object p3, p2, Lcom/zeekr/sdk/multidisplay/bean/CommBean;->domainName:Ljava/lang/String;

    invoke-static {p1}, Lcom/zeekr/sdk/multidisplay/utils/ScreenTypeCovertUtils;->screenType2deviceId(Ljava/lang/String;)I

    move-result p1

    invoke-virtual {p0, p3, p1, p2}, Lcom/zeekr/sdk/multidisplay/communication/CommImpl;->sendData(Ljava/lang/String;ILcom/zeekr/sdk/multidisplay/bean/CommBean;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p3, "startActivityOrService:IOException:"
...
.method public final startActivityOrServiceAsUser(Ljava/lang/String;Landroid/content/Intent;II)V
    .locals 2
    ...
    invoke-static {p2}, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;->getIntentString(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_0
    new-instance v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;

    invoke-direct {v0}, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;-><init>()V

    iput-object p2, v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;->intent:Landroid/content/Intent;

    iput p3, v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;->type:I

    iput p4, v0, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;->user:I
    ...
    const-string p3, "startActivityOrServiceAsUser"

    iput-object p3, p2, Lcom/zeekr/sdk/multidisplay/bean/CommBean;->dataId:Ljava/lang/String;

    :try_start_0
    const-class p3, Lcom/zeekr/sdk/multidisplay/communication/bean/StartActivityOrServiceAsUserBean;
...
.method public final unregisterCommCallback(Ljava/lang/String;ILcom/zeekr/sdk/multidisplay/contract/ICommDataCallback;)V
    ...
    const-string p1, "unregisterCommCallback->callback == null"
    ...
    const-string p1, "unregisterCommCallback has no register"
    ...
    const-string v6, "unregisterComCallback"
    ...
    const-string p1, "unregisterCommCallback success"
...
.method public final unregisterFileReceiveCallback(Ljava/lang/String;Lcom/zeekr/sdk/multidisplay/contract/IFileReceiveCallback;)V
    .locals 8

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v1, "unregisterFileReceiveCallback:"
    ...
    const-string v5, "unregisterFileReceiveCallback"
    ...
    iget-object p2, p2, Lcom/zeekr/sdk/multidisplay/contract/IBaseCallback;->callback:Lcom/zeekr/sdk/base/internal/IZeekrPlatformCallback;

    invoke-virtual {p1, v0, p2}, Lcom/zeekr/sdk/base/impl/ZeekrPlatformApiClient;->asyncCall(Lcom/zeekr/sdk/base/msg/ZeekrPlatformMessage;Lcom/zeekr/sdk/base/internal/IZeekrPlatformCallback;)Lcom/zeekr/sdk/base/msg/ZeekrPlatformRetMessage;

    move-result-object p1

    iget-object p2, v0, Lcom/zeekr/sdk/base/msg/ZeekrPlatformMessage;->mMethod:Ljava/lang/String;
    ...
    const-string v0, "unregisterFileReceiveCallback:IOException:"
