...
.method public static synthetic a(Lcom/zeekrlife/market/update/ZKMarketManager;Ljava/lang/String;Lcom/zeekrlife/market/update/ZKMarketManager$AppAvailableVersionCallback;Z)V
    .locals 0
...
.method public static synthetic b(Lcom/zeekrlife/market/update/ZKMarketManager;Ljava/lang/String;Lcom/zeekrlife/market/update/ZKMarketManager$AppCheckUpdateCallback;Z)V
    .locals 0
...
.method private taskInfoChanged(Lcom/zeekrlife/market/update/AppTaskInfo;)V
    ...
    invoke-interface {v2, p1}, Lcom/zeekrlife/market/update/ZKMarketManager$AppTaskInfoChangeListener;->onAppTaskInfoChanged(Lcom/zeekrlife/market/update/AppTaskInfo;)V
    ...
    const-string v1, "taskInfoChanged:"
    ...
    const-string v2, "taskInfoChanged exception : "
...
.method public getAppTaskInfo(Ljava/lang/String;)Lcom/zeekrlife/market/update/AppTaskInfo;
    ...
    :try_start_0
    const-string v0, " appTaskInfo is null "
    ...
    :cond_2
    :goto_0
    const-string p1, " taskInfoList is null "
    ...
    :cond_3
    const-string p1, " getAppTaskInfo appTaskInfo is null "
...
.method public getAppTaskInfoList()Ljava/util/List;
    ...
    :cond_2
    :goto_1
    const-string v2, " getAppTaskInfoList taskInfoList is null "
...
.method public onDownloadProgress(Ljava/lang/String;JJ)V
    ...
    const-string v1, "onDownloadProgress() called with: taskId = ["
    ...
    :cond_0
    const-string p1, "onDownloadProgress() appTaskInfo is null"
