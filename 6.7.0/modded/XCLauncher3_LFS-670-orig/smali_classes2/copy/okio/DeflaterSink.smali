...
.method public constructor <init>(Lcopy/okio/Buffer;Ljava/util/zip/Deflater;)V
    ...
    iput-object p1, p0, Lcopy/okio/DeflaterSink;->b:Lcopy/okio/Buffer;
...
.method public final J(Lcopy/okio/Buffer;J)V
    ...
    iget-object v4, p0, Lcopy/okio/DeflaterSink;->c:Ljava/util/zip/Deflater;

    invoke-virtual {v4, v2, v3, v1}, Ljava/util/zip/Deflater;->setInput([BII)V

    const/4 v2, 0x0

    invoke-virtual {p0, v2}, Lcopy/okio/DeflaterSink;->c(Z)V
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lcopy/okio/DeflaterSink;->b:Lcopy/okio/Buffer;

    :cond_0
    :goto_0
    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcopy/okio/Buffer;->R(I)Lcopy/okio/Segment;

    move-result-object v1

    iget-object v2, p0, Lcopy/okio/DeflaterSink;->c:Ljava/util/zip/Deflater;

    iget-object v3, v1, Lcopy/okio/Segment;->a:[B

    if-eqz p1, :cond_1

    iget v4, v1, Lcopy/okio/Segment;->c:I
    ...
    iget p1, v1, Lcopy/okio/Segment;->b:I

    iget v2, v1, Lcopy/okio/Segment;->c:I

    if-ne p1, v2, :cond_3

    invoke-virtual {v1}, Lcopy/okio/Segment;->a()Lcopy/okio/Segment;

    move-result-object p1

    iput-object p1, v0, Lcopy/okio/Buffer;->a:Lcopy/okio/Segment;

    invoke-static {v1}, Lcopy/okio/SegmentPool;->a(Lcopy/okio/Segment;)V
...
.method public final close()V
    ...
    invoke-virtual {p0, v1}, Lcopy/okio/DeflaterSink;->c(Z)V
    :try_end_0
...
.method public final flush()V
    ...
    invoke-virtual {p0, v0}, Lcopy/okio/DeflaterSink;->c(Z)V
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcopy/okio/DeflaterSink;->b:Lcopy/okio/Buffer;
