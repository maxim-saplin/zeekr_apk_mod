...
.method public final L(Lcopy/okio/Buffer;J)J
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Lcopy/okio/InflaterSource;->c(Lcopy/okio/Buffer;J)J
    ...
    invoke-interface {v0}, Lcopy/okio/BufferedSource;->E()Z
...
.method public final c(Lcopy/okio/Buffer;J)J
    .locals 7
    .param p1    # Lcopy/okio/Buffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iget-boolean v4, p0, Lcopy/okio/InflaterSource;->b:Z
    ...
    :try_start_0
    invoke-virtual {p1, v3}, Lcopy/okio/Buffer;->R(I)Lcopy/okio/Segment;
    ...
    :cond_1
    :try_start_1
    invoke-interface {v4}, Lcopy/okio/BufferedSource;->E()Z
