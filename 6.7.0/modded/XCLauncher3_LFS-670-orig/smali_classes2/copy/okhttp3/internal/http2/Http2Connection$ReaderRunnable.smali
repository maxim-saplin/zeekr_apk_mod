...
# virtual methods
.method public final a(ZILcopy/okio/RealBufferedSource;I)V
    .locals 16
    .param p3    # Lcopy/okio/RealBufferedSource;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iget-object v4, v1, Lcopy/okhttp3/internal/http2/Http2Connection$ReaderRunnable;->b:Lcopy/okhttp3/internal/http2/Http2Connection;
    ...
    invoke-virtual {v2, v3, v4}, Lcopy/okio/RealBufferedSource;->t(J)V

    invoke-virtual {v2, v6, v3, v4}, Lcopy/okio/RealBufferedSource;->L(Lcopy/okio/Buffer;J)J

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v3, v11, Lcopy/okhttp3/internal/http2/Http2Connection;->c:Ljava/lang/String;
    ...
    iget-object v0, v11, Lcopy/okhttp3/internal/http2/Http2Connection;->i:Lcopy/okhttp3/internal/concurrent/TaskQueue;
    ...
    invoke-virtual {v5, v0}, Lcopy/okhttp3/internal/http2/Http2Connection;->j(I)Lcopy/okhttp3/internal/http2/Http2Stream;
    ...
    invoke-virtual {v3, v0, v4}, Lcopy/okhttp3/internal/http2/Http2Connection;->q(ILcopy/okhttp3/internal/http2/ErrorCode;)V
    ...
    invoke-virtual {v0, v3, v4}, Lcopy/okhttp3/internal/http2/Http2Connection;->o(J)V

    invoke-virtual {v2, v3, v4}, Lcopy/okio/RealBufferedSource;->skip(J)V
    ...
    invoke-virtual {v2, v6, v7}, Lcopy/okio/RealBufferedSource;->skip(J)V
    ...
    invoke-virtual {v2, v8, v6, v7}, Lcopy/okio/RealBufferedSource;->L(Lcopy/okio/Buffer;J)J
    ...
    invoke-virtual {v11, v13}, Lcopy/okio/Buffer;->G(Lcopy/okio/Source;)J
    ...
    invoke-virtual {v0, v12, v13}, Lcopy/okhttp3/internal/http2/Http2Stream$FramingSource;->c(J)V
    ...
    invoke-virtual {v5, v0, v3}, Lcopy/okhttp3/internal/http2/Http2Stream;->j(Lcopy/okhttp3/Headers;Z)V
...
.method public final c(Ljava/util/List;IZ)V
    ...
    iget-object v5, v0, Lcopy/okhttp3/internal/http2/Http2Connection;->c:Ljava/lang/String;
    ...
    iget-object p1, v0, Lcopy/okhttp3/internal/http2/Http2Connection;->i:Lcopy/okhttp3/internal/concurrent/TaskQueue;
    ...
    invoke-virtual {v4, p2}, Lcopy/okhttp3/internal/http2/Http2Connection;->j(I)Lcopy/okhttp3/internal/http2/Http2Stream;
    ...
    iget-boolean v5, v4, Lcopy/okhttp3/internal/http2/Http2Connection;->f:Z
    :try_end_0
    ...
    :cond_2
    :try_start_1
    iget v5, v4, Lcopy/okhttp3/internal/http2/Http2Connection;->d:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget v4, v4, Lcopy/okhttp3/internal/http2/Http2Connection;->e:I
    ...
    :cond_4
    :try_start_3
    invoke-static {p1}, Lcopy/okhttp3/internal/Util;->v(Ljava/util/List;)Lcopy/okhttp3/Headers;
    ...
    iput p2, p3, Lcopy/okhttp3/internal/http2/Http2Connection;->d:I

    iget-object p3, p3, Lcopy/okhttp3/internal/http2/Http2Connection;->b:Ljava/util/LinkedHashMap;
    ...
    iget-object p3, p3, Lcopy/okhttp3/internal/http2/Http2Connection;->g:Lcopy/okhttp3/internal/concurrent/TaskRunner;
    ...
    iget-object v6, v6, Lcopy/okhttp3/internal/http2/Http2Connection;->c:Ljava/lang/String;
    ...
    invoke-direct {v3, p2, v4, p0, p1}, Lcopy/okhttp3/internal/http2/Http2Connection$ReaderRunnable$headers$$inlined$synchronized$lambda$1;-><init>(Ljava/lang/String;Lcopy/okhttp3/internal/http2/Http2Stream;Lcopy/okhttp3/internal/http2/Http2Connection$ReaderRunnable;Ljava/util/List;)V

    invoke-virtual {p3, v3, v1, v2}, Lcopy/okhttp3/internal/concurrent/TaskQueue;->c(Lcopy/okhttp3/internal/concurrent/Task;J)V
    :try_end_3
    ...
    invoke-virtual {v4, p1, p3}, Lcopy/okhttp3/internal/http2/Http2Stream;->j(Lcopy/okhttp3/Headers;Z)V
...
.method public final d(ILjava/util/List;)V
    ...
    :try_start_0
    iget-object v1, v0, Lcopy/okhttp3/internal/http2/Http2Connection;->z:Ljava/util/LinkedHashSet;
    ...
    invoke-virtual {v0, p1, p2}, Lcopy/okhttp3/internal/http2/Http2Connection;->q(ILcopy/okhttp3/internal/http2/ErrorCode;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final invoke()Ljava/lang/Object;
    ...
    :try_start_0
    invoke-virtual {v1, v3, p0}, Lcopy/okhttp3/internal/http2/Http2Reader;->c(ZLcopy/okhttp3/internal/http2/Http2Connection$ReaderRunnable;)Z
    ...
    :cond_0
    sget-object v3, Lcopy/okhttp3/internal/http2/ErrorCode;->b:Lcopy/okhttp3/internal/http2/ErrorCode;
    :try_end_1
    ...
    invoke-virtual {v0, v3, v2, v4}, Lcopy/okhttp3/internal/http2/Http2Connection;->c(Lcopy/okhttp3/internal/http2/ErrorCode;Lcopy/okhttp3/internal/http2/ErrorCode;Ljava/io/IOException;)V
    ...
    invoke-virtual {v0, v2, v2, v4}, Lcopy/okhttp3/internal/http2/Http2Connection;->c(Lcopy/okhttp3/internal/http2/ErrorCode;Lcopy/okhttp3/internal/http2/ErrorCode;Ljava/io/IOException;)V
