...
# instance fields
.field public final a:Lcopy/okhttp3/internal/connection/RealConnection;
...
.field public final c:Lcopy/okhttp3/EventListener;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public final d:Lcopy/okhttp3/internal/connection/ExchangeFinder;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public final e:Lcopy/okhttp3/internal/http/ExchangeCodec;
...
.method public constructor <init>(Lcopy/okhttp3/internal/connection/RealCall;Lcopy/okhttp3/EventListener;Lcopy/okhttp3/internal/connection/ExchangeFinder;Lcopy/okhttp3/internal/http/ExchangeCodec;)V
    ...
    iput-object p1, p0, Lcopy/okhttp3/internal/connection/Exchange;->b:Lcopy/okhttp3/internal/connection/RealCall;

    iput-object p2, p0, Lcopy/okhttp3/internal/connection/Exchange;->c:Lcopy/okhttp3/EventListener;

    iput-object p3, p0, Lcopy/okhttp3/internal/connection/Exchange;->d:Lcopy/okhttp3/internal/connection/ExchangeFinder;

    iput-object p4, p0, Lcopy/okhttp3/internal/connection/Exchange;->e:Lcopy/okhttp3/internal/http/ExchangeCodec;

    invoke-interface {p4}, Lcopy/okhttp3/internal/http/ExchangeCodec;->b()Lcopy/okhttp3/internal/connection/RealConnection;

    move-result-object p1

    iput-object p1, p0, Lcopy/okhttp3/internal/connection/Exchange;->a:Lcopy/okhttp3/internal/connection/RealConnection;
...
.method public final a(JZZLjava/io/IOException;)Ljava/io/IOException;
    ...
    :cond_0
    iget-object v0, p0, Lcopy/okhttp3/internal/connection/Exchange;->c:Lcopy/okhttp3/EventListener;

    iget-object v1, p0, Lcopy/okhttp3/internal/connection/Exchange;->b:Lcopy/okhttp3/internal/connection/RealCall;

    if-eqz p4, :cond_2

    if-eqz p5, :cond_1

    invoke-virtual {v0, v1, p5}, Lcopy/okhttp3/EventListener;->s(Lcopy/okhttp3/Call;Ljava/io/IOException;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v0, v1, p1, p2}, Lcopy/okhttp3/EventListener;->q(Lcopy/okhttp3/Call;J)V
    ...
    invoke-virtual {v0, v1, p5}, Lcopy/okhttp3/EventListener;->x(Lcopy/okhttp3/Call;Ljava/io/IOException;)V

    goto :goto_1

    :cond_3
    invoke-virtual {v0, v1, p1, p2}, Lcopy/okhttp3/EventListener;->v(Lcopy/okhttp3/Call;J)V
...
.method public final b(Lcopy/okhttp3/Request;)Lcopy/okio/Sink;
    ...
    iget-object v2, p0, Lcopy/okhttp3/internal/connection/Exchange;->c:Lcopy/okhttp3/EventListener;

    iget-object v3, p0, Lcopy/okhttp3/internal/connection/Exchange;->b:Lcopy/okhttp3/internal/connection/RealCall;

    invoke-virtual {v2, v3}, Lcopy/okhttp3/EventListener;->r(Lcopy/okhttp3/Call;)V

    iget-object v2, p0, Lcopy/okhttp3/internal/connection/Exchange;->e:Lcopy/okhttp3/internal/http/ExchangeCodec;

    invoke-interface {v2, p1, v0, v1}, Lcopy/okhttp3/internal/http/ExchangeCodec;->h(Lcopy/okhttp3/Request;J)Lcopy/okio/Sink;
...
.method public final c()Lcopy/okhttp3/internal/connection/RealConnection$newWebSocketStreams$1;
    ...
    iget-object v0, p0, Lcopy/okhttp3/internal/connection/Exchange;->b:Lcopy/okhttp3/internal/connection/RealCall;
    ...
    iput-boolean v1, v0, Lcopy/okhttp3/internal/connection/RealCall;->h:Z
    ...
    iget-object v0, p0, Lcopy/okhttp3/internal/connection/Exchange;->e:Lcopy/okhttp3/internal/http/ExchangeCodec;

    invoke-interface {v0}, Lcopy/okhttp3/internal/http/ExchangeCodec;->b()Lcopy/okhttp3/internal/connection/RealConnection;
    ...
    invoke-direct/range {v3 .. v8}, Lcopy/okhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lcopy/okhttp3/internal/connection/Exchange;Lcopy/okio/RealBufferedSource;Lcopy/okio/RealBufferedSink;Lcopy/okio/RealBufferedSource;Lcopy/okio/RealBufferedSink;)V
...
.method public final d(Z)Lcopy/okhttp3/Response$Builder;
    ...
    invoke-interface {v0, p1}, Lcopy/okhttp3/internal/http/ExchangeCodec;->c(Z)Lcopy/okhttp3/Response$Builder;
    ...
    invoke-virtual {v0, v1, p1}, Lcopy/okhttp3/EventListener;->x(Lcopy/okhttp3/Call;Ljava/io/IOException;)V
...
.method public final e(Ljava/io/IOException;)V
    ...
    iget-object v0, p0, Lcopy/okhttp3/internal/connection/Exchange;->d:Lcopy/okhttp3/internal/connection/ExchangeFinder;
