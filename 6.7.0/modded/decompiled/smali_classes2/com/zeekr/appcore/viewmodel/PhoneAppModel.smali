...
.method public final k(Landroid/database/Cursor;)Lcom/zeekr/appcore/mode/AppMetaData;
    ...
    sget-object v9, Lcom/zeekr/appcore/mode/AppType;->f:Lcom/zeekr/appcore/mode/AppType;
    ...
    iput-object p1, v0, Lcom/zeekr/appcore/mode/AppMetaData;->m:Ljava/lang/String;
...
.method public final t(Lcom/zeekr/appcore/mode/AppMetaData;)Z
    ...
    invoke-static {v0, v1, v2}, Lkotlin/text/StringsKt;->F(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-static {v1, p1, v3}, Lkotlin/text/StringsKt;->q(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result p1

    if-eqz p1, :cond_1

    const-string p1, "startCarLinkApp"
