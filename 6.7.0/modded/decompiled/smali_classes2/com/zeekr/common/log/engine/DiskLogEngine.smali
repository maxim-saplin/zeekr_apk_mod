...
# instance fields
.field public final a:Lcom/zeekr/carlauncher/CarLauncherApp;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/os/Looper;Lcom/zeekr/carlauncher/CarLauncherApp;)V
    .locals 2
    .param p1    # Landroid/os/Looper;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2    # Lcom/zeekr/carlauncher/CarLauncherApp;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object p2, p0, Lcom/zeekr/common/log/engine/DiskLogEngine;->a:Lcom/zeekr/carlauncher/CarLauncherApp;
    ...
    iput-wide v0, p0, Lcom/zeekr/common/log/engine/DiskLogEngine;->f:J
    ...
    iput-object p1, p0, Lcom/zeekr/common/log/engine/DiskLogEngine;->g:Landroid/os/UserManager;

    const-wide/32 p1, 0x36ee80

    iput-wide p1, p0, Lcom/zeekr/common/log/engine/DiskLogEngine;->i:J
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-wide v4, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->h:J
    ...
    iget-wide v4, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->i:J

    cmp-long v0, v2, v4

    iget-object v2, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->b:Ljava/lang/String;

    const/4 v3, 0x0

    const-string v4, "logs"

    iget-object v5, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->a:Lcom/zeekr/carlauncher/CarLauncherApp;

    if-lez v0, :cond_3

    iget-object v0, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->g:Landroid/os/UserManager;
    ...
    sget v9, Lcom/zeekr/common/log/core/DefaultLogDogConfig;->c:I
    ...
    sget v0, Lcom/zeekr/common/log/core/DefaultLogDogConfig;->c:I

    invoke-static {v0}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v0

    const-string v14, "\u5f53\u524d\u7684\u8bbe\u5b9a\u503c\uff1a  "
    ...
    iput-wide v6, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->h:J
    ...
    iget-object v6, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->e:Ljava/lang/String;
    ...
    sget-boolean v6, Lcom/zeekr/common/log/core/DefaultLogDogConfig;->b:Z
    ...
    invoke-static {v0, v4}, Landroid/car/a;->A(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v5, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->d:Ljava/io/File;

    iput-object v0, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->e:Ljava/lang/String;

    :cond_6
    iget-object v0, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->d:Ljava/io/File;
    ...
    :cond_8
    iget-object v4, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->d:Ljava/io/File;
    ...
    iget-wide v6, v1, Lcom/zeekr/common/log/engine/DiskLogEngine;->f:J
