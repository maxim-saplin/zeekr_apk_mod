...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object v8, v0, Lokio/internal/ResourceFileSystem;->c:Lokio/FileSystem;
    ...
    invoke-static {v9, v10}, Lokio/Path$Companion;->b(Lokio/Path$Companion;Ljava/io/File;)Lokio/Path;
    ...
    invoke-static {v4, v3, v5}, Lkotlin/text/StringsKt;->x(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v8, v3}, Lokio/FileSystem;->h(Lokio/Path;)Lokio/FileHandle;

    move-result-object v7

    :try_start_0
    invoke-virtual {v7}, Lokio/FileHandle;->m()J
    ...
    :goto_4
    invoke-virtual {v7, v10, v11}, Lokio/FileHandle;->n(J)Lokio/Source;
    ...
    :try_start_1
    invoke-virtual {v5}, Lokio/RealBufferedSource;->r()I
    ...
    invoke-virtual {v5}, Lokio/RealBufferedSource;->x()S
    ...
    invoke-virtual {v5, v13, v14}, Lokio/RealBufferedSource;->y(J)Ljava/lang/String;
    :try_end_2
    ...
    invoke-virtual {v7, v9, v10}, Lokio/FileHandle;->n(J)Lokio/Source;
    ...
    :try_start_5
    invoke-virtual {v1}, Lokio/RealBufferedSource;->r()I
    ...
    invoke-virtual {v1, v9, v10}, Lokio/RealBufferedSource;->skip(J)V
    ...
    invoke-virtual {v1}, Lokio/RealBufferedSource;->t()J
    ...
    invoke-static {v9}, Lokio/internal/ZipFilesKt;->b(I)Ljava/lang/String;
    ...
    :cond_9
    :goto_8
    iget-wide v9, v1, Lokio/internal/EocdRecord;->b:J
    ...
    :try_start_d
    iget-wide v11, v1, Lokio/internal/EocdRecord;->a:J
    ...
    iget-wide v13, v1, Lokio/internal/ZipEntry;->g:J
    ...
    invoke-direct {v4, v3, v8, v0}, Lokio/ZipFileSystem;-><init>(Lokio/Path;Lokio/FileSystem;Ljava/util/LinkedHashMap;)V
    :try_end_e
    ...
    :cond_12
    invoke-static {v6, v2}, Lkotlin/collections/CollectionsKt;->H(Ljava/util/List;Ljava/util/List;)Ljava/util/ArrayList;
