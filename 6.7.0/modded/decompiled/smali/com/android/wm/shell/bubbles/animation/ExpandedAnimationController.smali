...
.method public static synthetic g(Lcom/android/wm/shell/bubbles/animation/ExpandedAnimationController;ZILcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    .locals 0
...
.method public static synthetic h(ILcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    .locals 0
...
.method private synthetic lambda$startOrUpdatePathAnimation$3(ZILcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    ...
    invoke-virtual {v4, p2, v5}, Lcom/android/wm/shell/bubbles/BubblePositioner;->getExpandedBubbleXY(ILcom/android/wm/shell/bubbles/BubbleStackView$StackViewState;)Landroid/graphics/PointF;
    ...
    iget v8, p0, Lcom/android/wm/shell/bubbles/animation/ExpandedAnimationController;->mStackOffsetPx:F
    ...
    invoke-virtual {v4, v2}, Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout;->isFirstChildXLeftOfCenter(F)Z
    ...
    invoke-virtual {p1, v2}, Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout;->isFirstChildXLeftOfCenter(F)Z
    ...
    :goto_4
    new-instance v4, Lcom/android/wm/shell/bubbles/animation/c;

    invoke-direct {v4, p0, v0}, Lcom/android/wm/shell/bubbles/animation/c;-><init>(Lcom/android/wm/shell/bubbles/animation/ExpandedAnimationController;I)V
    ...
    invoke-virtual {p3, v3, p1, p2, v0}, Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->followAnimatedTargetAlongPath(Landroid/graphics/Path;ILandroid/animation/TimeInterpolator;[Ljava/lang/Runnable;)Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method private startOrUpdatePathAnimation(Z)V
    ...
    new-instance v2, Lcom/android/wm/shell/bubbles/animation/c;

    invoke-direct {v2, p0, v1}, Lcom/android/wm/shell/bubbles/animation/c;-><init>(Lcom/android/wm/shell/bubbles/animation/ExpandedAnimationController;I)V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/wm/shell/bubbles/animation/c;-><init>(Lcom/android/wm/shell/bubbles/animation/ExpandedAnimationController;I)V

    :goto_0
    new-instance v3, Lcom/android/wm/shell/bubbles/animation/d;

    invoke-direct {v3, p0, p1}, Lcom/android/wm/shell/bubbles/animation/d;-><init>(Lcom/android/wm/shell/bubbles/animation/ExpandedAnimationController;Z)V
...
.method public snapBubbleBack(Landroid/view/View;FF)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;->animationForChildAtIndex(I)Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {v1, v3, v2, v4}, Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->position(FF[Ljava/lang/Runnable;)Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    move-result-object v1

    invoke-virtual {v1, p2, p3}, Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->withPositionStartVelocities(FF)Lcom/android/wm/shell/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    move-result-object p2

    new-instance p3, Lcom/android/wm/shell/bubbles/animation/a;

    invoke-direct {p3, p1, v0}, Lcom/android/wm/shell/bubbles/animation/a;-><init>(Landroid/view/View;I)V
