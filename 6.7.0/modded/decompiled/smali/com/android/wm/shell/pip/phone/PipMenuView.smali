...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/pip/phone/PhonePipMenuController;Lcom/android/wm/shell/common/ShellExecutor;Landroid/os/Handler;Ljava/util/Optional;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/wm/shell/pip/phone/f0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;I)V
    ...
    new-instance p4, Lcom/android/wm/shell/pip/phone/g0;

    const/4 p5, 0x0

    invoke-direct {p4, p0, p5}, Lcom/android/wm/shell/pip/phone/g0;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic b(Lcom/android/wm/shell/pip/phone/PipMenuView;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic d(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
    .locals 0
...
.method public static synthetic g(Lcom/android/wm/shell/pip/phone/PipMenuView;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic h(Lcom/android/wm/shell/pip/phone/PipMenuActionView;Landroid/graphics/drawable/Drawable;)V
    .locals 0
...
.method private updateActionViews(ILandroid/graphics/Rect;)V
    ...
    invoke-direct {v2}, Lcom/android/wm/shell/pip/phone/h0;-><init>()V
    ...
    new-instance v7, Lcom/android/wm/shell/pip/phone/i0;

    invoke-direct {v7, v1}, Lcom/android/wm/shell/pip/phone/i0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuActionView;)V
    ...
    new-instance v2, Lcom/android/wm/shell/pip/phone/g0;

    const/4 v6, 0x4

    invoke-direct {v2, p2, v6}, Lcom/android/wm/shell/pip/phone/g0;-><init>(Ljava/lang/Object;I)V
...
.method public hideMenu(Ljava/lang/Runnable;ZZI)V
    ...
    invoke-direct {p0, v2, p3, v3}, Lcom/android/wm/shell/pip/phone/PipMenuView;->notifyMenuStateChangeStart(IZLjava/lang/Runnable;)V
    ...
    iget-object v4, p0, Lcom/android/wm/shell/pip/phone/PipMenuView;->mMenuBgUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public showMenu(ILandroid/graphics/Rect;ZZZZ)V
    ...
    iget-object v7, v0, Lcom/android/wm/shell/pip/phone/PipMenuView;->mContext:Landroid/content/Context;

    invoke-virtual {v7}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v7

    sget v8, Lcom/android/wm/shell/R$bool;->config_pipEnableEnterSplitButton:I
    ...
    iget-object v10, v0, Lcom/android/wm/shell/pip/phone/PipMenuView;->mMenuBgUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    invoke-static {v13, v9, v7}, Landroid/animation/ObjectAnimator;->ofFloat(Ljava/lang/Object;Landroid/util/Property;[F)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v5, p0, v1, v2}, Lcom/android/wm/shell/pip/phone/PipMenuView$3;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;IZ)V
    ...
    invoke-direct {v2, p0, v6}, Lcom/android/wm/shell/pip/phone/f0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;I)V

    invoke-direct {p0, v1, v3, v2}, Lcom/android/wm/shell/pip/phone/PipMenuView;->notifyMenuStateChangeStart(IZLjava/lang/Runnable;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/wm/shell/pip/phone/PipMenuView;->repostDelayedHide(I)V
