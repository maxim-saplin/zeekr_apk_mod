...
.method public static buildStaticLayout(Ljava/lang/CharSequence;IILandroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/TextDirectionHeuristic;FFZLandroid/text/TextUtils$TruncateAt;III)Landroid/text/StaticLayout;
    ...
    invoke-static/range {v2 .. v15}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->buildStaticLayoutwithBuilder(Ljava/lang/CharSequence;IILandroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/TextDirectionHeuristic;FFZLandroid/text/TextUtils$TruncateAt;II[I)Landroid/text/StaticLayout;
...
.method public static getLabelLayout(IIZZLjava/lang/String;IFIIIIIIIFIIIIIFFFFZZLjava/lang/String;Lcom/antfin/cube/cubecore/layout/CKTextParseResult;Ljava/lang/String;Z)Lcom/antfin/cube/cubecore/layout/CKTextLayout;
    ...
    :try_start_0
    iget-object v7, v12, Lcom/antfin/cube/cubecore/layout/CKTextParseResult;->data:Ljava/lang/String;
    ...
    aget-object v10, v16, p7

    move-object/from16 v11, p26

    move-object/from16 v1, p28

    invoke-static {v11, v10, v1}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->getTypeFace(Ljava/lang/String;Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFFontStyle;Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    :cond_3
    sget-object v9, Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFFontStyle;->MFFONT_ITALIC:Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFFontStyle;
    :try_end_0
    ...
    cmpl-float v16, v6, v9

    if-lez v16, :cond_6

    :cond_5
    cmpl-float v16, v1, v9
    ...
    :goto_5
    invoke-virtual {v8, v1, v5, v6, v9}, Landroid/graphics/Paint;->setShadowLayer(FFFI)V
    ...
    sget-object v6, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;->MFTEXT_ALIGNMENT_Center:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;
    ...
    :cond_8
    sget-object v6, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;->MFTEXT_ALIGNMENT_Right:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;
    ...
    sget-object v5, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKLineBreakMode;->MFLINE_BREAK_MODE_WORD_WRAP_OVERFLOW:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKLineBreakMode;
    ...
    invoke-virtual {v0, v6, v9, v11, v12}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v0, v11, v9, v6, v12}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    ...
    invoke-direct {v6, v14}, Lcom/antfin/cube/cubecore/layout/CKLineHeightSpan;-><init>(I)V
    ...
    :goto_16
    sget-object v23, Landroid/text/TextDirectionHeuristics;->FIRSTSTRONG_LTR:Landroid/text/TextDirectionHeuristic;
    ...
    invoke-static/range {v17 .. v30}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->buildStaticLayout(Ljava/lang/CharSequence;IILandroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/TextDirectionHeuristic;FFZLandroid/text/TextUtils$TruncateAt;III)Landroid/text/StaticLayout;
    ...
    invoke-static {v6, v0}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->partedStr(Landroid/text/Layout;Ljava/lang/CharSequence;)Ljava/util/ArrayList;
    ...
    check-cast v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;

    iget-boolean v9, v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;->overflowFlag:Z

    if-eqz v9, :cond_2d

    iget-object v9, v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;

    invoke-static {v9, v15}, Landroid/text/BoringLayout;->isBoring(Ljava/lang/CharSequence;Landroid/text/TextPaint;)Landroid/text/BoringLayout$Metrics;

    move-result-object v9

    if-eqz v9, :cond_2b

    iget-object v11, v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;
    ...
    :cond_2e
    iget-object v2, v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;

    invoke-static {v2, v15}, Landroid/text/Layout;->getDesiredWidth(Ljava/lang/CharSequence;Landroid/text/TextPaint;)F
    ...
    iget-boolean v0, v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;->overflowFlag:Z

    if-eqz v0, :cond_32

    iget-object v0, v8, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;
    ...
    filled-new-array {v6}, [Landroid/text/Layout;
    ...
    :goto_2f
    invoke-static {v1}, Lcom/antfin/cube/platform/common/CKJNIObjectAllocate;->alloc(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    new-instance v2, Lcom/antfin/cube/cubecore/layout/CKTextLayout;

    invoke-direct {v2, v1, v0, v8}, Lcom/antfin/cube/cubecore/layout/CKTextLayout;-><init>(Ljava/lang/Object;[FF)V
...
.method public static getRichLabelLayout(IIIILjava/lang/String;IFIIIIIIFIIIIIFFFFZZLjava/lang/String;Lcom/antfin/cube/cubecore/layout/CKTextParseResult;ILjava/lang/String;Z)Lcom/antfin/cube/cubecore/layout/CKTextLayout;
    ...
    iget-object v0, v12, Lcom/antfin/cube/cubecore/layout/CKTextParseResult;->data:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v7, v6, v10}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->getTypeFace(Ljava/lang/String;Lcom/antfin/cube/cubecore/layout/style/CKStyleLabelObject$MFFontStyle;Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    :goto_2
    invoke-virtual {v9, v8, v4, v5, v11}, Landroid/graphics/Paint;->setShadowLayer(FFFI)V
    :try_end_4
    ...
    sget-object v8, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;->MFTEXT_ALIGNMENT_Center:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;
    ...
    :cond_a
    sget-object v8, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;->MFTEXT_ALIGNMENT_Right:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKTextAlignment;
    ...
    invoke-virtual {v9, v4}, Landroid/graphics/Paint;->setLetterSpacing(F)V
    :try_end_7
    ...
    invoke-virtual {v3, v4, v10, v8, v7}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    :try_end_a
    ...
    invoke-virtual {v3, v8, v10, v4, v7}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    :try_end_13
    ...
    invoke-direct {v4, v14}, Lcom/antfin/cube/cubecore/layout/CKLineHeightSpan;-><init>(I)V
    ...
    sget-object v8, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKLineTruncateMode;->MFLINE_TRUNCATE_MODE_CLIPPING:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKLineTruncateMode;
    ...
    :try_start_1a
    invoke-static/range {v12 .. v21}, Landroid/text/BoringLayout;->make(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;FFLandroid/text/BoringLayout$Metrics;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/BoringLayout;
    ...
    invoke-static/range {v12 .. v25}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->buildStaticLayout(Ljava/lang/CharSequence;IILandroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/TextDirectionHeuristic;FFZLandroid/text/TextUtils$TruncateAt;III)Landroid/text/StaticLayout;
    ...
    sget-object v13, Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKLineBreakMode;->MFLINE_BREAK_MODE_WORD_WRAP_OVERFLOW:Lcom/antfin/cube/cubecore/layout/style/CKStyle$CKLineBreakMode;
    :try_end_21
    ...
    check-cast v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;

    iget-boolean v12, v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;->overflowFlag:Z

    if-eqz v12, :cond_32

    iget-object v12, v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;

    move-object/from16 v14, p1

    invoke-static {v12, v14}, Landroid/text/BoringLayout;->isBoring(Ljava/lang/CharSequence;Landroid/text/TextPaint;)Landroid/text/BoringLayout$Metrics;

    move-result-object v12

    if-eqz v12, :cond_31

    iget-object v6, v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;
    ...
    invoke-static/range {p2 .. p11}, Landroid/text/BoringLayout;->make(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;FFLandroid/text/BoringLayout$Metrics;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/BoringLayout;
    ...
    iget-boolean v2, v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;->overflowFlag:Z

    if-eqz v2, :cond_34

    iget-object v0, v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;
    ...
    invoke-static/range {p2 .. p15}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->buildStaticLayout(Ljava/lang/CharSequence;IILandroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/TextDirectionHeuristic;FFZLandroid/text/TextUtils$TruncateAt;III)Landroid/text/StaticLayout;
    ...
    iget-object v2, v5, Lcom/antfin/cube/cubecore/layout/CKPartedText;->partedString:Ljava/lang/CharSequence;
    ...
    :try_start_26
    invoke-direct {v2, v0, v1, v3}, Lcom/antfin/cube/cubecore/layout/CKTextLayout;-><init>(Ljava/lang/Object;[FF)V
    ...
    invoke-static {v1, v6, v4, v5}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->caculateSpanFrames([Lcom/antfin/cube/cubecore/layout/CKLabelComponent;Landroid/text/Layout;ZLjava/util/List;)[Lcom/antfin/cube/cubecore/layout/CKTextLayoutLink;
    ...
    invoke-static {v0, v6, v7, v5}, Lcom/antfin/cube/cubecore/layout/CKLayoutUtil;->caculateSpanFrames([Lcom/antfin/cube/cubecore/layout/CKLabelComponent;Landroid/text/Layout;ZLjava/util/List;)[Lcom/antfin/cube/cubecore/layout/CKTextLayoutLink;
    ...
    :try_start_27
    invoke-direct {v1, v2, v0, v3}, Lcom/antfin/cube/cubecore/layout/CKTextLayout;-><init>(Ljava/lang/Object;[FF)V
    :try_end_27
    ...
    const-string v4, "getRichLabelLayout error "

    invoke-static {v1, v4, v0}, Lcom/antfin/cube/platform/util/CKLogUtil;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
