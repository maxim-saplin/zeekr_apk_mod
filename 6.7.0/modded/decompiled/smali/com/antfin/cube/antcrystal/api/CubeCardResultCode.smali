...
.method static constructor <clinit>()V
    ...
    const-string v2, "CubeCardResultNetworkError"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    const-string v3, "CubeCardResultParamError"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;->CubeCardResultParamError:Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    new-instance v3, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    const-string v4, "CubeCardResultNotExist"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;->CubeCardResultNotExist:Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    new-instance v4, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    const-string v5, "CubeCardResultContentInvalid"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;->CubeCardResultContentInvalid:Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;

    move-result-object v0

    sput-object v0, Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;->$VALUES:[Lcom/antfin/cube/antcrystal/api/CubeCardResultCode;
