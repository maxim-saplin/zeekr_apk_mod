...
.method public final a(Landroid/graphics/Matrix;Lcom/google/android/material/shadow/ShadowRenderer;ILandroid/graphics/Canvas;)V
    ...
    :cond_1
    iget-object v15, v0, Lcom/google/android/material/shape/ShapePath$InnerCornerShadowOperation;->c:Lcom/google/android/material/shape/ShapePath$PathLineOperation;

    iget v4, v15, Lcom/google/android/material/shape/ShapePath$PathLineOperation;->b:F
    ...
    iget v4, v15, Lcom/google/android/material/shape/ShapePath$PathLineOperation;->c:F
    ...
    iget v12, v4, Lcom/google/android/material/shape/ShapePath$PathLineOperation;->b:F

    iget v13, v15, Lcom/google/android/material/shape/ShapePath$PathLineOperation;->b:F
    ...
    iget v14, v15, Lcom/google/android/material/shape/ShapePath$PathLineOperation;->c:F
    ...
    invoke-virtual {v2, v0, v3, v15}, Landroid/graphics/Path;->arcTo(Landroid/graphics/RectF;FF)V
    ...
    invoke-virtual {v11, v0, v3}, Landroid/graphics/Canvas;->scale(FF)V
    ...
    invoke-direct {v0, v3, v3, v2, v3}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    invoke-virtual {v10, v1}, Landroid/graphics/Matrix;->preRotate(F)Z

    double-to-float v1, v12

    invoke-virtual {v10, v1, v3}, Landroid/graphics/Matrix;->preTranslate(FF)Z

    move/from16 v1, p3

    move-object v2, v10

    invoke-virtual {v9, v11, v2, v0, v1}, Lcom/google/android/material/shadow/ShadowRenderer;->b(Landroid/graphics/Canvas;Landroid/graphics/Matrix;Landroid/graphics/RectF;I)V
