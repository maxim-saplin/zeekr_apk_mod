...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/alipay/mobile/antcube/handler/CKFalconPerformanceHandler;->f:Ljava/util/concurrent/ConcurrentHashMap;

    :try_start_0
    sget-object v1, Lcom/alipay/mobile/antcube/handler/CKConfigHandler;->b:Lcom/alipay/mobile/antcube/handler/CKConfigHandler;

    const-string v2, "falcon_pv_max_count"

    invoke-virtual {v1, v2}, Lcom/alipay/mobile/antcube/handler/CKConfigHandler;->getSingleConfig(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput v2, Lcom/alipay/mobile/antcube/handler/CKFalconPerformanceHandler;->e:I
    ...
    :cond_0
    :goto_0
    const-string v2, "falcon_render_time_count"
...
.method public final a()V
    ...
    invoke-static {v1, v5}, Landroid/car/a;->A(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final commit(Lcom/antfin/cube/platform/handler/ICKPerformanceHandler$PerformanceType;Lcom/antfin/cube/platform/common/CKPerformance;Ljava/util/Map;)V
    ...
    :cond_9
    iget-object v9, v8, Lcom/alipay/mobile/antcube/handler/CKFalconPerformanceHandler;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v11, v5}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V
    ...
    invoke-virtual {v11, v3, v12}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Lcom/alibaba/fastjson/JSON;->F(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v15, v5}, Lcom/antfin/cube/cubecore/api/CKPageInstanceManger;->getPageInstance(Ljava/lang/String;)Lcom/antfin/cube/cubecore/api/CKPageInstance;

    move-result-object v5

    if-eqz v5, :cond_1f

    invoke-virtual {v5}, Lcom/antfin/cube/cubecore/api/CKPageInstance;->getBizCode()Ljava/lang/String;
    ...
    :cond_1c
    invoke-virtual {v5}, Lcom/antfin/cube/cubecore/api/CKPageInstance;->getTemplateId()Ljava/lang/String;
    ...
    :cond_1d
    invoke-virtual {v5}, Lcom/antfin/cube/cubecore/api/CKPageInstance;->isSupportJs()Z
    ...
    :cond_1e
    invoke-virtual {v5}, Lcom/antfin/cube/cubecore/api/CKPageInstance;->getTemplateName()Ljava/lang/String;

    move-result-object v14

    invoke-virtual {v5}, Lcom/antfin/cube/cubecore/api/CKPageInstance;->getTemplateVersion()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v5}, Lcom/antfin/cube/cubecore/api/CKPageInstance;->getOutterCardUid()Ljava/lang/String;
